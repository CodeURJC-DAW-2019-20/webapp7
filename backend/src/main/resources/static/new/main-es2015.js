...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">¿Quiénes somos?</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a href=\"/\">Inicio</a></li>\n                        <li>¿Quiénes somos?</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <div class=\"content-block\">\n        <div class=\"section-full content-inner overlay-white-middle\">\n            <div class=\"container\">\n                <div class=\"row align-items-center m-b50\">\n                    <div class=\"col-md-12 col-lg-6 m-b20\">\n                        <h2 class=\"m-b5\">¿Quiénes somos?</h2>\n                        <h3 class=\"fw4\">Te ayudamos a ayudar</h3>\n                        <p class=\"m-b15\">Voluntaweb es una web que creamos para facilitar y promover el voluntariado. Esta web facilita la comunicación entre organizaciones no lucrativas y personas que desean ayudar.</p>\n                        <p class=\"m-b15\">Para llevar acabo nuestro cometido ponemos en contacto a personas que deseen colaborar en actos de voluntariado con organizaciones no lucrativas, aportando asi su tiempo y talento en distintas acciones sociales.</p>\n                    </div>\n                    <div class=\"col-md-12 col-lg-6\">\n                        <img src=\"/assets/images/our-work/aboutus.jpg\" alt=\"\" />\n                    </div>\n                </div>\n                <div class=\"row\">\n                    <div class=\"col-lg-4 col-md-4 col-sm-12 m-b30\">\n                        <div class=\"icon-bx-wraper p-a30 center bg-gray radius-sm\">\n                            <div class=\"icon-md text-primary m-b20\"> <a href=\"#\" class=\"icon-cell text-primary\"><i class=\"ti-desktop\"></i></a> </div>\n                            <div class=\"icon-content\">\n                                <h5 class=\"dlab-tilte text-uppercase\">Para las ONGs</h5>\n                                <p>Te ayudamos a publicitar las campañas en las que necesites colaboración.</p>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-lg-4 col-md-4 col-sm-12 m-b30\">\n                        <div class=\"icon-bx-wraper p-a30 center bg-gray radius-sm\">\n                            <div class=\"icon-md text-primary m-b20\"> <a href=\"#\" class=\"icon-cell text-primary\"><i class=\"ti-image\"></i></a> </div>\n                            <div class=\"icon-content\">\n                                <h5 class=\"dlab-tilte text-uppercase\">Para voluntarios</h5>\n                                <p>Te ayudamos en la busqueda de un voluntariado en el que puedas ayudar y se adecue a ti.</p>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-lg-4 col-md-4 col-sm-12 m-b30\">\n                        <div class=\"icon-bx-wraper p-a30 center bg-gray radius-sm\">\n                            <div class=\"icon-md text-primary m-b20\"> <a href=\"#\" class=\"icon-cell text-primary\"><i class=\"ti-cup\"></i></a> </div>\n                            <div class=\"icon-content\">\n                                <h5 class=\"dlab-tilte text-uppercase\">Siempre a tu disposición</h5>\n                                <p>Si no sabes como colaborar, estamos aqui para guiarte.</p>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- Why Chose Us -->\n        <!-- Call To Action -->\n        <div class=\"section-full content-inner-2 call-to-action overlay-black-dark text-white text-center bg-img-fix\" style=\"background-image: url('assets/images/background/volunteer.png');\">\n            <div class=\"container\">\n                <div class=\"row\">\n                    <div class=\"col-lg-12\">\n                        <h2 class=\"m-b10\">Encuentra el voluntariado adecuado para ti</h2>\n                        <p class=\"m-b0\">Podrás buscar voluntariados adecuados para ti y comunicarte directamente con las ONG con las que desees colaborar.</p>\n                        <a [routerLink]=\"['/register']\" class=\"site-button m-t20 outline outline-2 radius-xl\">Crear una cuenta</a>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- Call To Action END -->\n    </div>\n    <!-- contact area END -->\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-comments/admin-comments.component.html":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-comments/admin-comments.component.html ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Browse Jobs -->\n        <div class=\"section-full bg-white browse-job content-inner-2\">\n            <div class=\"container\">\n                <!--<div class=\"row\">-->\n                <div class=\"col-md-12 text-center\">\n                    <h5 class=\"widget-title font-weight-700 text-uppercase mb-5\">Comentarios</h5>\n                    <ul class=\"post-job-bx\">\n                        <li *ngFor = \"let c of comments\">\n                            <a>\n                                <div class=\"d-flex m-b30\">\n                                    <div class=\"job-post-info text-left\">\n                                        <h4>{{c.name}}</h4>\n                                        <ul>\n                                            <li>Email: {{c.email}}</li>\n                                            <li><span>ID mensaje: {{c.id}}</span></li>\n                                        </ul>\n                                    </div>\n                                </div>\n                                <div class=\"d-flex\">\n                                    <div class=\"job-time mr-auto\">\n                                        <p>{{c.message}}</p>\n                                    </div>\n                                </div>\n                                <div class = \"text-rigth\">\n                                    <input type = \"submit\" class = \"site-button\" value = \"Eliminar\" (click) = \"deleteComment(c.id)\"/>\n                                </div>\n                            </a>    \n                        </li>\n                    </ul>\n                </div>\n            </div>\n        </div>\n        <!-- Browse Jobs END -->\n    </div>\n</div>\n<!-- Content END-->\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-ngos/admin-ngos.component.html":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-ngos/admin-ngos.component.html ***!
  \*******************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Browse Jobs -->\n        <div class=\"section-full bg-white browse-job content-inner-2\">\n            <div class=\"container\">\n                <!--<div class=\"row\">-->\n                <div class=\"col-md-12 text-center\">\n                    <h5 class=\"widget-title font-weight-700 text-uppercase\">ONGs registradas:</h5>\n                    <ul class=\"post-job-bx\">\n                        <li *ngFor=\"let ngo of data\">\n                            <a>\n                                <div class=\"d-flex m-b30\">\n                                    <div class=\"job-post-company\">\n                                        <span class=\"container-volunteering\"><img src=\"{{url}}ongs/{{ngo.image}}/image\" onerror=\"this.onerror=null;this.src='/assets/images/user-placeholder.png'\" class=\"avatar\"/></span>\n                                    </div>\n                                    <div class=\"job-post-info text-left\">\n                                        <h4>{{ngo.name}}</h4>\n                                        <ul>\n                                            <li>ID: {{ngo.id}}</li>\n                                            <li><i class=\"fa fa-envelope-o\"></i>{{ngo.email}}</li>\n                                        </ul>\n                                    </div>\n                                </div>\n                                <div align=\"center\">\n                                    <input type = \"submit\" class = \"site-button\" value = \"Eliminar\" (click)=\"deleteNgo(ngo.id, $event)\" style=\"background-color:rgb(255, 58, 58)\"/>\n                                </div>\n                            </a>\n                        </li>\n                    </ul>\n                    <br>\n                    <div *ngIf=\"loading\" align=\"center\" class=\"mt-5 mb-5\">\n                        <img src=\"assets/images/loading.svg\" alt=\"\">\n                    </div>\n                    <div *ngIf=\"more && !loading\" class=\"d-flex\">\n                        <div class=\"text-center\">\n                            <button class=\"site-button m-r5 button-lg\" (click)=\"moreNgos()\">Cargar más</button> \n                        </div>\n                    </div>\n                </div>\n                <!--</div>-->\n            </div>\n        </div>\n        <!-- Browse Jobs END -->\n    </div>\n</div>\n<!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Browse Jobs -->\n        <div class=\"section-full bg-white browse-job content-inner-2\">\n            <div class=\"container\">\n                <!--<div class=\"row\">-->\n                <div class=\"col-md-12 text-center\">\n                    <h5 class=\"widget-title font-weight-700 text-uppercase\">Usuarios registrados:</h5>\n                    <ul class=\"post-job-bx\">\n                        <li *ngFor=\"let user of data\">\n                            <a>\n                                <div class=\"d-flex m-b30\">\n                                    <div class=\"job-post-company\">\n                                        <span><img src=\"{{url}}users/{{user.image}}/image\" onerror=\"this.onerror=null;this.src='/assets/images/user-placeholder.png'\" class=\"avatar\"/></span>\n                                    </div>\n                                    <div class=\"job-post-info text-left\">\n                                        <h4>{{user.name}} {{user.surname}}</h4>\n                                        <ul>\n                                            <li>ID: {{user.id}}</li>\n                                            <li><i class=\"fa fa-envelope-o\"></i>{{user.email}}</li>\n                                        </ul>\n                                    </div>\n                                </div>\n                                <div class = \"text-rigth\">\n                                    <input type = \"submit\" class = \"site-button\" value = \"Eliminar\" (click)=\"deleteUser(user.id, $event)\" style=\"background-color:rgb(255, 58, 58)\"/>\n                                </div>\n                            </a>\n                        </li>\n                    </ul>\n                    <br>\n                    <div *ngIf=\"loading\" align=\"center\" class=\"mt-5 mb-5\">\n                        <img src=\"assets/images/loading.svg\" alt=\"\">\n                    </div>\n                    <div *ngIf=\"more && !loading\" class=\"d-flex\">\n                        <div class=\"text-center\">\n                            <button class=\"site-button m-r5 button-lg\" (click)=\"moreUsers()\">Cargar más</button> \n                        </div>\n                    </div>\n                </div>\n                <!--</div>-->\n            </div>\n        </div>\n        <!-- Browse Jobs END -->\n    </div>\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-volunteerings/admin-volunteerings.component.html":
/*!*************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-volunteerings/admin-volunteerings.component.html ***!
  \*************************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Browse Jobs -->\n        <div class=\"section-full bg-white browse-job content-inner-2\">\n            <div class=\"container\">\n                <!--<div class=\"row\">-->\n                <div class=\"col-md-12 text-center\">\n                    <h5 class=\"widget-title font-weight-700 text-uppercase\">Voluntariados publicados:</h5>\n                    <ul class=\"post-job-bx\">\n                        <li *ngFor=\"let volunteering of data\">\n                            <a>\n                                <div class=\"d-flex m-b30\">\n                                    <div class=\"job-post-company\">\n                                        <span class=\"container-volunteering\"><img src=\"{{url}}volunteerings/image/{{volunteering.image}}\" onerror=\"this.onerror=null;this.src='/assets/images/user-placeholder.png'\" class=\"avatar\"/></span>\n                                    </div>\n                                    <div class=\"job-post-info text-left\">\n                                        <h3>{{volunteering.name}}</h3>\n                                        <ul>\n                                            <li>ID: {{volunteering.id}}</li>\n                                            <li><i class=\"fa fa-envelope-o\"></i>{{volunteering.email}}</li>\n                                        </ul>\n                                    </div>\n                                </div>\n                                <div class = \"text-rigth\">\n                                    <input type = \"submit\" class = \"site-button\" value = \"Eliminar\" (click)=\"deleteVolunteering(volunteering.id, $event)\" style=\"background-color:rgb(255, 58, 58)\"/>\n                                </div>\n                            </a>\n                        </li>\n                    </ul>\n                    <br>\n                    <div *ngIf=\"loading\" align=\"center\" class=\"mt-5 mb-5\">\n                        <img src=\"assets/images/loading.svg\" alt=\"\">\n                    </div>\n                    <div *ngIf=\"more && !loading\" class=\"d-flex\">\n                        <div class=\"text-center\">\n                            <button class=\"site-button m-r5 button-lg\" (click)=\"moreVolunteerings()\">Cargar más</button> \n                        </div>\n                    </div>\n                </div>\n                <!--</div>-->\n            </div>\n        </div>\n        <!-- Browse Jobs END -->\n    </div>\n</div>\n<!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Contacta con nosotros</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>Contacta con nosotros</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"section-full content-inner bg-white contact-style-1\">\n        <div class=\"container\">\n            <div class=\"row\">\n                <!-- right part start -->\n                <div class=\"col-lg-4 col-md-6 d-lg-flex d-md-flex\">\n                    <div class=\"p-a30 border m-b30 contact-area border-1 align-self-stretch radius-sm\">\n                        <h4 class=\"m-b10\">Encuéntranos rápidamente</h4>\n                        <p>Si tienes alguna pregunta utiliza los siguientes medios para contactar con nosotros:</p>\n                        <ul class=\"no-margin\">\n                            <li class=\"icon-bx-wraper left m-b30\">\n                                <div class=\"icon-bx-xs border-1\"> <a href=\"#\" class=\"icon-cell\"><i class=\"ti-location-pin\"></i></a> </div>\n                                <div class=\"icon-content\">\n                                    <h6 class=\"text-uppercase m-tb0 dez-tilte\">Dirección:</h6>\n                                    <p>Calle Tulipán, s/n, 28933 Móstoles, Madrid</p>\n                                </div>\n                            </li>\n                            <li class=\"icon-bx-wraper left  m-b30\">\n                                <div class=\"icon-bx-xs border-1\"> <a href=\"#\" class=\"icon-cell\"><i class=\"ti-email\"></i></a> </div>\n                                <div class=\"icon-content\">\n                                    <h6 class=\"text-uppercase m-tb0 dez-tilte\">Correo electrónico:</h6>\n                                    <p>ejemplodedirección@correo.com</p>\n                                </div>\n                            </li>\n                            <li class=\"icon-bx-wraper left\">\n                                <div class=\"icon-bx-xs border-1\"> <a href=\"#\" class=\"icon-cell\"><i class=\"ti-mobile\"></i></a> </div>\n                                <div class=\"icon-content\">\n                                    <h6 class=\"text-uppercase m-tb0 dez-tilte\">Teléfono:</h6>\n                                    <p>+34 123 123 123</p>\n                                </div>\n                            </li>\n                        </ul>\n                    </div>\n                </div>\n                <!-- right part END -->\n                <!-- Left part start -->\n                <div class=\"col-lg-4 col-md-6\">\n                    <div class=\"p-a30 m-b30 radius-sm bg-gray clearfix\">\n                        <h4>Mándanos un mensaje</h4>\n                        <form #contactForm=\"ngForm\" (ngSubmit)=\"onSubmit(contactForm)\">\n                            <div class=\"row\">\n                                <div class=\"col-lg-12\">\n                                    <div class=\"alert alert-success mt-3\" *ngIf=\"status == 'success'\">¡Se ha enviado tu comentario!</div>\n                                    <div class=\"alert alert-danger mt-3\" *ngIf=\"status == 'error'\">¡No se ha podido enviar el comentario!</div>\n                                    <div class=\"form-group\">\n                                        <div class=\"input-group\">\n                                            <input name=\"name\" type=\"text\" required class=\"form-control\" placeholder=\"Tu nombre\" #name=\"ngModel\" [(ngModel)]=\"comment.name\">\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12\">\n                                    <div class=\"form-group\">\n                                        <div class=\"input-group\"> \n                                            <input name=\"email\" type=\"email\" class=\"form-control\" required  placeholder=\"Tu dirección de correo electrónico\" #email=\"ngModel\" [(ngModel)]=\"comment.email\">\n                                        </div>\n                                    </div>\n                                </div>\n                                 <div class=\"col-lg-12\">\n                                    <div class=\"form-group\">\n                                        <div class=\"input-group\">\n                                            <textarea name=\"message\" rows=\"4\" class=\"form-control\" required placeholder=\"Escribe aquí tu mensaje\" #message=\"ngModel\" [(ngModel)]=\"comment.message\"></textarea>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12\">\n                                    <button name=\"submit\" type=\"submit\" value=\"Submit\" class=\"site-button\" [disabled]=\"contactForm.invalid\"> <span>Enviar</span> </button>\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n                <!-- Left part END -->\n                <div class=\"col-lg-4 col-md-12 d-lg-flex m-b30\">\n                    <iframe src=\"https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5852.700264209454!2d-3.8762892141462193!3d40.33710091837508!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x841755428455a90b!2sUniversidad%20Rey%20Juan%20Carlos!5e0!3m2!1ses!2ses!4v1580299735901!5m2!1ses!2ses\" class=\"align-self-stretch radius-sm\" style=\"border:0; width:100%; min-height:350px;\" allowfullscreen></iframe>\n                </div>\n            </div>\n        </div>\n    </div>\n    <!-- contact area  END -->\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/create-volunteering/create-volunteering.component.html":
/*!*************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/create-volunteering/create-volunteering.component.html ***!
  \*************************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\"\n        style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Crear anuncio</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>Crear anuncio</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- panel area -->\n    <div class=\"py-4\">\n\n        <div class=\"row justify-content-center\">\n            <div class=\"col-md-8\">\n\n\n                <div class=\"card\">\n                    <div class=\"card-header\">Anuncio</div>\n\n                    <div class=\"card-body\">\n                        <div class=\"alert alert-success mt-3\" *ngIf=\"status == 'success'\">¡Has publicado un nuevo voluntariado! Haz click <a [routerLink]=\"['/volunteering/',volunteering.id]\">aquí</a> para verlo.</div>\n                        <div class=\"alert alert-danger mt-3\" *ngIf=\"status == 'error'\">No se ha podido publicar tu anuncio. Inténtalo de nuevo.</div>\n                        <!-- Settings form -->\n                        <form #formCreateVolunteering = \"ngForm\" (ngSubmit) = \"onSubmit(formCreateVolunteering)\" *ngIf = \"!volunteering.id && categories\">\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"name\" class=\"col-md-4 col-form-label text-md-right\">Nombre</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"name\" type=\"text\" class=\"form-control\" name=\"name\" #name = \"ngModel\" [(ngModel)] = \"volunteering.name\"\n                                        placeholder=\"Nombre\" autocomplete=\"name\" autofocus required [disabled] =\"volunteering.id != null\">\n                                    <span *ngIf = \"name.touched && !name.valid && volunteering.id ==null\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"city\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Ciudad</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"city\" type=\"text\" class=\"form-control\" name=\"city\" #city = \"ngModel\" [(ngModel)] = \"volunteering.city\"\n                                        placeholder=\"Ciudad\" autocomplete=\"city\" autofocus required [disabled] =\"volunteering.id != null\">\n                                    <span *ngIf = \"city.touched && !city.valid && volunteering.id ==null\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"categoryId\" class=\"col-md-4 col-form-label text-md-right\">Categoría</label>\n                                \n                                <div class=\"col-md-6\">\n                                    <select name=\"category\" class=\"form-control\" [(ngModel)] = \"category\" [disabled] =\"volunteering.id != null\">\n                                            <option *ngFor=\"let c of categories\" [ngValue]=\"c.id\">{{c.name}}</option>\n                                    </select>\n                                </div>\n\n                            </div>\n                            \n\n                            <div class=\"form-group row\">\n                                <label for=\"startdate\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Fecha de inicio</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"startdate\" type=\"date\" class=\"form-control\" name=\"startdate\" #startdate = \"ngModel\" [(ngModel)] = \"volunteering.startdate\"\n                                        placeholder=\"Fecha de inicio\" autocomplete=\"startdate\" autofocus required [disabled] =\"volunteering.id != null\">\n                                    <span *ngIf = \"startdate.touched && !startdate.valid && volunteering.id ==null\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"enddate\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Fecha de finalización</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"enddate\" type=\"date\" class=\"form-control\" name=\"enddate\" #enddate = \"ngModel\" [(ngModel)] = \"volunteering.enddate\"\n                                        placeholder=\"Fecha de finalización\" autocomplete=\"enddate\" autofocus required [disabled] =\"volunteering.id != null\">\n                                    <span *ngIf = \"enddate.touched && !enddate.valid && volunteering.id ==null\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n\n\n                            <div class=\"form-group row\">\n                                <label for=\"description\" class=\"col-md-4 col-form-label  text-md-right\">Descripción</label>\n\n                                <div class=\"col-md-6\">\n                                        <textarea class=\"form-control\" name=\"description\" placeholder=\"Descripción\" #description = \"ngModel\" [(ngModel)] = \"volunteering.description\" \n                                        required [disabled] =\"volunteering.id != null\"></textarea>\n                                        <span *ngIf = \"description.touched && !description.valid && volunteering.id ==null\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                                                                \n                            <div class=\"form-group row\">\n                                <label for=\"email\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Email</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"email\" type=\"text\" class=\"form-control\" name=\"email\" #email = \"ngModel\" [(ngModel)] = \"volunteering.email\"\n                                        placeholder=\"Email\" autocomplete=\"email\" autofocus required [disabled] =\"volunteering.id != null\">\n                                        <span *ngIf = \"email.touched && !email.valid && volunteering.id ==null\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row mb-4\">\n                                <div class=\"col-md-6 offset-md-4\">\n                                    <input type = \"submit\" value = \"Guardar cambios\" [disabled] = \"!formCreateVolunteering.valid || volunteering.id != null\"/>\n                                </div>\n                            </div>\n                        </form>\n\n                        <form #formSubidaImagen = \"ngForm\" (ngSubmit) = \"onImageSubmit()\" *ngIf = \"volunteering.id\">\n                            <div class=\"form-group row\">\n                                <label for=\"imagenFile\" class=\"col-md-4 col-form-label text-md-right\">Foto del anuncio</label>\n\n\n                                <div class=\"form-group row\">\n                                    <angular-file-uploader class=\"pointer\" [config]=\"afuConfig\" (ApiResponse)=\"avatarUpload($event)\" name=\"file0\"></angular-file-uploader>\n                                </div>\n\n                                <div *ngIf=\"volunteering.image && volunteering.image != 'false'\"><img class=\"avatar-edit mt-3\" src=\"{{url}}volunteerings/image/{{volunteering.image}}\" height=\"200\" width=\"200\" alt=\"\"></div>\n                            </div>\n                            <div class=\"form-group row mb-4\">\n                                <div class=\"col-md-6 offset-md-4\">\n                                    <input type = \"submit\" class = \"site-button\" value = \"Subir imagen\"/>\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n<!-- Content END-->\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/edit-volunteering/edit-volunteering.component.html":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/edit-volunteering/edit-volunteering.component.html ***!
  \*********************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\"\n        style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Editar anuncio</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>Crear anuncio</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- panel area -->\n    <div class=\"py-4\">\n\n        <div class=\"row justify-content-center\">\n            <div class=\"col-md-8\">\n\n\n                <div class=\"card\">\n                    <div class=\"card-header\">Anuncio</div>\n\n                    <div class=\"card-body\">\n                        <!-- Settings form -->\n                        <form #formCreateVolunteering = \"ngForm\" (ngSubmit) = \"onSubmit()\">\n                            <div class=\"form-group row\">\n                                <label for=\"name\" class=\"col-md-4 col-form-label text-md-right\">Nombre</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"name\" type=\"text\" class=\"form-control\" name=\"name\" #name = \"ngModel\" [(ngModel)] = \"volunteering.name\"\n                                        placeholder=\"Nombre\" autocomplete=\"name\" autofocus required>\n                                    <span *ngIf = \"name.touched && !name.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"city\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Ciudad</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"city\" type=\"text\" class=\"form-control\" name=\"city\" #city = \"ngModel\" [(ngModel)] = \"volunteering.city\"\n                                        placeholder=\"Ciudad\" autocomplete=\"city\" autofocus required>\n                                    <span *ngIf = \"city.touched && !city.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"categoryId\" class=\"col-md-4 col-form-label text-md-right\">Categoría</label>\n                                \n                                <div class=\"col-md-6\">\n                                    <select name=\"category\" class=\"form-control\" [(ngModel)] = \"category\">\n                                            <option *ngFor=\"let c of categories\" [ngValue]=\"c.id\">{{c.name}}</option>\n                                    </select>\n                                </div>\n\n                            </div>\n                            \n\n                            <div class=\"form-group row\">\n                                <label for=\"startdate\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Fecha de inicio</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"startdate\" type=\"date\" class=\"form-control\" name=\"startdate\" #startdate = \"ngModel\" [(ngModel)] = \"volunteering.startdate\"\n                                        placeholder=\"Fecha de inicio\" autocomplete=\"startdate\" autofocus required>\n                                    <span *ngIf = \"startdate.touched && !startdate.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"enddate\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Fecha de finalización</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"enddate\" type=\"date\" class=\"form-control\" name=\"enddate\" #enddate = \"ngModel\" [(ngModel)] = \"volunteering.enddate\"\n                                        placeholder=\"Fecha de finalización\" autocomplete=\"enddate\" autofocus required>\n                                    <span *ngIf = \"enddate.touched && !enddate.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n\n\n                            <div class=\"form-group row\">\n                                <label for=\"description\" class=\"col-md-4 col-form-label  text-md-right\">Descripción</label>\n\n                                <div class=\"col-md-6\">\n                                         <textarea class=\"form-control\" name=\"description\" placeholder=\"Descripción\" #description = \"ngModel\" [(ngModel)] = \"volunteering.description\" required></textarea>\n                                         <span *ngIf = \"description.touched && !description.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"email\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Email</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"email\" type=\"text\" class=\"form-control\" name=\"email\" #email = \"ngModel\" [(ngModel)] = \"volunteering.email\"\n                                        placeholder=\"Email\" autocomplete=\"email\" autofocus required>\n                                        <span *ngIf = \"email.touched && !email.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"imagenFile\" class=\"col-md-4 col-form-label text-md-right\">Foto del\n                                    anuncio</label>\n\n                                <div class=\"col-md-6\">\n                                    <angular-file-uploader class=\"pointer\" [config]=\"afuConfig\" (ApiResponse)=\"avatarUpload($event)\" name=\"file0\">\n                                    </angular-file-uploader>\n\n                                    <div *ngIf=\"volunteering.image && volunteering.image != 'false'\"><img class=\"avatar-edit mt-3\" src=\"{{url}}volunteerings/image/{{volunteering.image}}\" height=\"200\" width=\"200\" alt=\"\"></div>\n                                </div>\n\n\n                                \n                            </div>\n                                                                \n                            \n\n\n                            <div class=\"form-group row mb-0\">\n                                <div class=\"col-md-6 offset-md-4\">\n                                    <input type = \"submit\" value = \"Guardar cambios\" [disabled] = \"!formCreateVolunteering.valid\"/>\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n<!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("    <!-- Footer -->\n    <footer class=\"site-footer\">\n\t\t<div class=\"footer-top\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-xl-5 col-lg-4 col-md-12 col-sm-12\">\n\t\t\t\t\t<div class=\"widget\">\n\t\t\t\t\t\t<img src=\"./assets/images/logo.png\" width=\"250\" class=\"m-b15\" alt=\"\"/>\n\t\t\t\t\t\t<p class=\"text-capitalize m-b20\">Plataforma líder en la búsqueda de voluntariados y ONGs.</p>\n\t\t\t\t\t\t<div class=\"subscribe-form m-b20\">\n\t\t\t\t\t\t\t<div class=\"icon-content\">\n\t\t\t\t\t\t\t\t<h6 class=\"text-uppercase m-tb0 dez-tilte\"><i class=\"ti-location-pin\"></i> Dirección:</h6>\n\t\t\t\t\t\t\t\t<p>Calle Tulipán, s/n, 28933 Móstoles, Madrid</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-xl-5 col-lg-5 col-md-8 col-sm-8 col-12\">\n\t\t\t\t\t<div class=\"widget border-0\">\n\t\t\t\t\t\t<h5 class=\"m-b30 text-white\">Enlaces de interés</h5>\n\t\t\t\t\t\t<ul class=\"list-line\">\n\t\t\t\t\t\t\t<li><a [routerLink]=\"['/about-us']\">¿Quiénes somos?</a></li>\n\t\t\t\t\t\t\t<li><a [routerLink]=\"['/contact']\">Contacto</a></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t\t<!-- footer bottom part -->\n\t\t<div class=\"footer-bottom\">\n\t\t\t<div class=\"container\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-lg-12 text-center\"><span><a target=\"_blank\" href=\"https://www.urjc.es\">DAW GIS\n\t\t\t\t\t\t\t\t2019-2020</a></span></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</footer>\n    <!-- Footer END -->\n    <!--<button class=\"scroltop fa fa-chevron-up\" ></button>-->\n<!-- JAVASCRIPT FILES ========================================= -->\n<script src=\"./assets/js/jquery.min.js\"></script><!-- JQUERY.MIN JS -->\n<script src=\"./assets/plugins/wow/wow.js\"></script><!-- WOW JS -->\n<script src=\"./assets/plugins/bootstrap/js/popper.min.js\"></script><!-- BOOTSTRAP.MIN JS -->\n<script src=\"./assets/plugins/bootstrap/js/bootstrap.min.js\"></script><!-- BOOTSTRAP.MIN JS -->\n<script src=\"./assets/plugins/bootstrap-select/bootstrap-select.min.js\"></script><!-- FORM JS -->\n<script src=\"./assets/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.js\"></script><!-- FORM JS -->\n<script src=\"./assets/plugins/magnific-popup/magnific-popup.js\"></script><!-- MAGNIFIC POPUP JS -->\n<script src=\"./assets/plugins/counter/waypoints-min.js\"></script><!-- WAYPOINTS JS -->\n<script src=\"./assets/plugins/counter/counterup.min.js\"></script><!-- COUNTERUP JS -->\n<script src=\"./assets/plugins/imagesloaded/imagesloaded.js\"></script><!-- IMAGESLOADED -->\n<script src=\"./assets/plugins/masonry/masonry-3.1.4.js\"></script><!-- MASONRY -->\n<script src=\"./assets/plugins/masonry/masonry.filter.js\"></script><!-- MASONRY -->\n<script src=\"./assets/plugins/owl-carousel/owl.carousel.js\"></script><!-- OWL SLIDER -->\n<script src=\"./assets/plugins/rangeslider/rangeslider.js\" ></script><!-- Rangeslider -->\n<script src=\"./assets/js/custom.js\"></script><!-- CUSTOM FUCTIONS  -->\n<script src=\"./assets/js/dz.carousel.js\"></script><!-- SORTCODE FUCTIONS  -->\n<script src=\"./assets/js/dz.ajax.js\"></script><!-- CONTACT JS  -->\n ");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- Section Banner -->\n    <div class=\"dez-bnr-inr dez-bnr-inr-md\" style=\"background-image:url(assets/images/main-slider/slide2.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry align-m \">\n                <div class=\"find-job-bx\">\n                    <!--<p class=\"site-button button-sm\">Find Jobs, Employment & Career Opportunities</p>-->\n                    <h2>Busca Entre Mas De <br /> <span class=\"text-primary\">50,000</span> Voluntariados.</h2>\n                    <div class=\"container\">\n                        <form #formSearch=\"ngForm\" (ngSubmit)=\"onSubmit()\" class=\"dezPlaceAni\">\n                            <div class=\"row\">\n                                <div class=\"form-group\">\n                                    <div class=\"input-group\">\n                                        <input (keypress)=\"prevent($event)\" class=\"mb-1\" type=\"text\" name=\"search\" class=\"form-control\" placeholder=\"Título, Palabras Clave, o Frases\" #search=\"ngModel\" [(ngModel)]=key>\n                                        <br>\n                                        <a *ngIf=\"key == undefined\" [routerLink]=\"['/search']\" class=\"site-button btn-block\">Buscar</a>\n                                        <a *ngIf=\"key != undefined\" [routerLink]=\"['/search',key]\" class=\"site-button btn-block\">Buscar</a>\n                                    </div>\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <!-- Section Banner END -->\n    <!-- About Us -->\n    <div class=\"section-full job-categories content-inner-2 bg-white\" style=\"background-image:url(assets/images/pattern/pic1.html);\">\n        <div class=\"container\">\n            <div class=\"section-head d-flex head-counter clearfix\">\n                <div class=\"mr-auto\">\n                    <h2 class=\"m-b5\">Categorias Populares</h2>\n                    <h6 class=\"fw3\">Hay mas de 10 categorias de voluntariados esperandote</h6>\n                </div>\n            </div>\n            <div class=\"row sp20\">\n                <div *ngFor=\"let category of categories\" class=\"col-lg-3 col-md-6 col-sm-6\">\n                    <div class=\"icon-bx-wraper\">\n                        <div class=\"icon-content\">\n                            <div class=\"icon-md text-primary m-b20\"><i class=\"ti-location-pin\"></i></div>\n                            <span class=\"dez-tilte\">{{category.name}}</span>\n                            <div class=\"rotate-icon\"><i class=\"ti-location-pin\"></i></div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-lg-12 text-center m-t30\">\n                    <a [routerLink]=\"['/search']\"><button class=\"site-button radius-xl\">Buscar por categoría</button></a>\n                </div>\n            </div>\n        </div>\n    </div>\n    <!-- About Us END -->\n    <div class=\"section-full content-inner bg-gray\">\n        <div class=\"container\">\n            <div class=\"row text-center bg-gray\">\n                <h2 class=\"text-center\">Algunas de nuestras estadísticas</h2>\n            </div>\n            <div class=\"container\">\n                <div style=\"display: block\">\n                    <div id=\"chartContainer\" style=\"height: 370px; width: 100%;\"></div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/joined-volunteerings/joined-volunteerings.component.html":
/*!***************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/joined-volunteerings/joined-volunteerings.component.html ***!
  \***************************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Mis voluntariados</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a href=\"index.html\">Inicio</a></li>\n                        <li>Mis voluntariados</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Browse Jobs -->\n        <div class=\"section-full bg-white browse-job content-inner-2\">\n            <div class=\"container\">\n                <!--<div class=\"row\">-->\n                    <div class=\"col-md-12 text-center\">\n                        <h5 class=\"widget-title font-weight-700 text-uppercase\">Mis voluntariados</h5>\n                        <ul class=\"post-job-bx\">\n                            \n                            <div *ngIf=\"!joined\" align=\"center\" class=\"mt-5 mb-5\">\n                                <img src=\"assets/images/loading.svg\" alt=\"\">\n                            </div>\n                        \n                        <li *ngFor=\"let v of joined\">\n                            <a [routerLink]=\"['/volunteering', v.id]\">\n                                <div class=\"d-flex m-b30\">\n                                    <div class=\"job-post-company\">\n                                        <span class=\"container-volunteering\"><img src=\"{{url}}volunteerings/image/{{v.image}}\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\"/></span>\n                                    </div>\n                                    <div class=\"job-post-info\">\n                                        <h4>{{v.name}}</h4>\n                                        <ul class=\"text-left\">\n                                            <li><i class=\"fa fa-map-marker\"></i>{{v.city}}</li>\n                                        </ul>\n                                    </div>\n                                </div>\n                                <div class=\"d-flex\">\n                                    <div class=\"job-time mr-auto\">\n                                        <span>{{v.category}}</span>\n                                    </div>\n                                    <div class=\"pagination-bx\">\n                                        <span>{{v.ong}}</span>\n                                    </div>\n                                </div>\n                            </a>\n                        </li>\n\n                    </ul>\n                 \n                </div>\n\n                <!--</div>-->\n            </div>\n        </div>\n        <!-- Browse Jobs END -->\n    </div>\n</div>\n<!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("    <!-- Content -->\n    <div class=\"page-content bg-white\">\n        <!-- inner page banner -->\n        <div class=\"dez-bnr-inr overlay-black-middle bg-pt\" style=\"background-image:url(assets/images/banner/bnr2.jpg);\">\n            <div class=\"container\">\n                <div class=\"dez-bnr-inr-entry\">\n                    <h1 class=\"text-white\">{{page_title}}</h1>\n\t\t\t\t\t<!-- Breadcrumb row -->\n\t\t\t\t\t<div class=\"breadcrumb-row\">\n\t\t\t\t\t\t<ul class=\"list-inline\">\n\t\t\t\t\t\t\t<li><a href=\"index.html\">Home</a></li>\n\t\t\t\t\t\t\t<li>{{page_title}}</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t\t<!-- Breadcrumb row END -->\n                </div>\n            </div>\n        </div>\n        <!-- inner page banner END -->\n        <!-- contact area -->\n        <div class=\"section-full content-inner-2 shop-account\">\n            <!-- Product -->\n            <div class=\"container\">\n                <div class=\"row\">\n\t\t\t\t\t<div class=\"col-md-12 text-center\">\n\t\t\t\t\t\t<h3 class=\"font-weight-700 m-t0 m-b20\">Inicia Sesión Con Tu Cuenta</h3>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n                <div>\n\t\t\t\t\t<div class=\"max-w500 m-auto m-b30\">\n\t\t\t\t\t\t<div class=\"p-a30 border-1 seth\">\n\t\t\t\t\t\t\t<div class=\"tab-content nav\">\n\t\t\t\t\t\t\t\t<form id=\"login\" class=\"tab-pane active col-12 p-a0\" #loginForm=\"ngForm\" (ngSubmit)=\"onSubmit(loginForm)\">\n\t\t\t\t\t\t\t\t\t<h4 class=\"font-weight-700\">Inicia Sesión</h4>\n\t\t\t\t\t\t\t\t\t<p class=\"font-weight-600\">Si tienes una cuenta con nosotros, por favor inicia sesión.</p>\n\t\t\t\t\t\t\t\t\t<div class=\"alert alert-danger mt-3\" *ngIf=\"status == 'error'\">Las credenciales de inicio de sesión no son\n\t\t\t\t\t\t\t\t\t\tcorrectas.</div>\n\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t\t\t\t<label class=\"font-weight-700\">E-MAIL *</label>\n                                        <input name=\"email\" required=\"\" class=\"form-control\" placeholder=\"Tu Email\" type=\"email\" #email=\"ngModel\" [(ngModel)]=\"logeable.email\" required pattern=\"^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$\">\n                                        <small class=\"invalid-feedback d-block\" *ngIf=\"!email.valid && email.touched\">El email no es válido.</small>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t\t\t\t<label class=\"font-weight-700\">CONTRASEÑA *</label>\n                                        <input name=\"password\" required=\"\" class=\"form-control \" placeholder=\"Contraseña\" type=\"password\" #password=\"ngModel\" [(ngModel)]=\"logeable.password\" required>\n                                        <small class=\"invalid-feedback d-block\" *ngIf=\"!password.valid && password.touched\">La contraseña no es\n                                            válida.</small>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"text-left\">\n\t\t\t\t\t\t\t\t\t\t<button class=\"site-button m-r5 button-lg\" [disabled]=\"loginForm.invalid\">Inicia Sesión</button>\n\t\t\t\t\t\t\t\t\t\t<input class=\"ml-5\" type=\"radio\" value=\"user\" name=\"user_or_ngo\" #user_or_ngo=\"ngModel\" [(ngModel)]=\"logeable.type\"> Usuario\n\t\t\t\t\t\t\t\t\t\t<input class=\"ml-2\" type=\"radio\" value=\"ngo\" name=\"user_or_ngo\" #user_or_ngo=\"ngModel\" [(ngModel)]=\"logeable.type\"> ONG\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t\t\t<form id=\"forgot-password\" class=\"tab-pane fade  col-12 p-a0\">\n\t\t\t\t\t\t\t\t\t<h4 class=\"font-weight-700\">¿OLVIDÓ SU CONTRASEÑA?</h4>\n\t\t\t\t\t\t\t\t\t<p class=\"font-weight-600\">Te enviaremos un email para restablecer tu contraseña. </p>\n\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t\t\t\t<label class=\"font-weight-700\">E-MAIL *</label>\n\t\t\t\t\t\t\t\t\t\t<input name=\"dzName\" required=\"\" class=\"form-control\" placeholder=\"Tu Email\" type=\"email\">\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"text-left\"> \n\t\t\t\t\t\t\t\t\t\t<button class=\"site-button pull-right button-lg\">Enviar</button>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n            <!-- Product END -->\n\t\t</div>\n\t\t<!-- contact area  END -->\n    </div>\n    <!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("    <div class=\"page-wraper\">\n    <!--<div id=\"loading-area\"></div>-->\n        <!-- header -->\n        <header class=\"site-header mo-left header fullwidth\">\n            <!-- main header -->\n            <div class=\"sticky-header main-bar-wraper navbar-expand-lg\">\n                <div class=\"main-bar clearfix\">\n                    <div class=\"container clearfix\">\n                        <!-- website logo -->\n                        <div class=\"logo-header mostion\">\n                            <a [routerLink]=\"['/']\"><img src=\"assets/images/logo.png\" class=\"logo\" alt=\"\"></a>\n                        </div>\n                        <!-- nav toggle button -->\n                        <!-- nav toggle button -->\n                        <button class=\"navbar-toggler collapsed navicon justify-content-end\" type=\"button\"\n                            data-toggle=\"collapse\" data-target=\"#navbarNavDropdown\" aria-controls=\"navbarNavDropdown\"\n                            aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n                            <span></span>\n                            <span></span>\n                            <span></span>\n                        </button>\n\n                        <!-- Anonymous Navbar -->\n                        <div class=\"extra-nav\" *ngIf=\"!identity\">\n                            <div class=\"extra-cell\">\n                                <a [routerLink]=\"['/register']\" class=\"site-button\"><i class=\"fa fa-user\"></i> Regístrate</a>\n                                <a [routerLink]=\"['/login']\" class=\"site-button\"><i class=\"fa fa-lock\"></i> Inicia sesión</a>\n                            </div>\n                        </div>\n\n                        <!-- Logged User Navbar -->\n\t\t\t\t\t\t<div class=\"extra-nav\" *ngIf=\"identity && entity_type == 'user'\">\n\t\t\t\t\t\t\t<ul class=\"navbar-nav\">\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<div class=\"container-avatar\">\n\t\t\t\t\t\t\t\t\t\t<img src=\"{{url}}users/{{identity.image}}/image\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\">\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t<li class=\"nav-item dropdown\">\n\t\t\t\t\t\t\t\t\t<a id=\"navbarDropdown\" class=\"nav-link dropdown-toggle reset-color\" href=\"#\"\n\t\t\t\t\t\t\t\t\t\trole=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\"\n\t\t\t\t\t\t\t\t\t\tv-pre>\n\t\t\t\t\t\t\t\t\t\t{{identity.name}} <span class=\"caret\"></span>\n\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"navbarDropdown\" *ngIf=\"!identity.roles.includes('ROLE_ADMIN')\">\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['user/myvolunteerings']\">\n\t\t\t\t\t\t\t\t\t\t\tMis voluntariados\n\t\t\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/user/settings']\">\n\n\t\t\t\t\t\t\t\t\t\t\tAjustes\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item pointer\" (click)=\"logout()\">\n\t\t\t\t\t\t\t\t\t\t\tCerrar sesión\n\t\t\t\t\t\t\t\t\t\t</a>\n                                    </div>\n                                    \n                                    <div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"navbarDropdown\" *ngIf=\"identity.roles.includes('ROLE_ADMIN')\">\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/admin/volunteerings']\">\n\t\t\t\t\t\t\t\t\t\t\tVoluntariados\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/admin/users']\">\n\t\t\t\t\t\t\t\t\t\t\tUsuarios registrados\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/admin/ngos']\">\n\t\t\t\t\t\t\t\t\t\t\tONGs registradas\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/admin/comments']\">\n\t\t\t\t\t\t\t\t\t\t\tComentarios\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item pointer\" (click)=\"logout()\">\n\t\t\t\t\t\t\t\t\t\t\tCerrar sesión\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t</div>\n                                </li>\n                                \n\t\t\t\t\t\t\t</ul>\n                        </div>\n                        \n                        <!-- Logged NGO Navbar -->\n\t\t\t\t\t\t<div class=\"extra-nav\" *ngIf=\"identity && entity_type == 'ngo'\">\n\t\t\t\t\t\t\t<ul class=\"navbar-nav\">\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<div class=\"container-avatar\">\n\t\t\t\t\t\t\t\t\t\t<img src=\"{{url}}ongs/{{identity.image}}/image\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\">\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t<li class=\"nav-item dropdown\">\n\t\t\t\t\t\t\t\t\t<a id=\"navbarDropdown\" class=\"nav-link dropdown-toggle reset-color\" href=\"#\"\n\t\t\t\t\t\t\t\t\t\trole=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\"\n\t\t\t\t\t\t\t\t\t\tv-pre>\n\t\t\t\t\t\t\t\t\t\t{{identity.name}} <span class=\"caret\"></span>\n\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"navbarDropdown\">\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/ngo/myvolunteerings']\">\n\t\t\t\t\t\t\t\t\t\t\tMis voluntariados\n\t\t\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" [routerLink]=\"['/ngo/settings']\">\n\n\t\t\t\t\t\t\t\t\t\t\tAjustes\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item pointer\" (click)=\"logout()\">\n\t\t\t\t\t\t\t\t\t\t\tCerrar sesión\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\n                        \n                        <!-- main nav -->\n                        <div class=\"header-nav navbar-collapse collapse justify-content-start\" id=\"navbarNavDropdown\">\n                            <ul class=\"nav navbar-nav\">\n                                <li>\n                                    <a [routerLink]=\"['/']\">Inicio</a>\n                                </li>\n                                <li>\n                                    <a [routerLink]=\"['/search']\">Voluntariados</a>\n                                </li>\n                                <li><a [routerLink]=\"['/ngos']\">ONGs</a></li>\n                                \n                                <li class=\"ls-mobile\">\n                                    <a [routerLink]=\"['/register']\">Regístrate <i class=\"fa fa-user\"></i></a>\n                                </li>\n                                <li class=\"ls-mobile\">\n                                    <a [routerLink]=\"['/login']\">Inicia sesión <i class=\"fa fa-lock\"></i></a>\n                                </li>\n                            </ul>\n                        </div>\n                    </div>\n                </div>\n            </div>\n    \n            <!-- main header END -->\n        </header>\n        <!-- header END -->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-details/ngo-details.component.html":
/*!*********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-details/ngo-details.component.html ***!
  \*********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/fondo.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 *ngIf=\"!loading\" class=\"text-white\">{{current_ngo.name}}</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li *ngIf=\"!loading\">{{current_ngo.name}}</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- NGO -->\n        <div class=\"section-full content-inner-1\">\n            <div class=\"container\">\n                <div *ngIf=\"loading\" align=\"center\" class=\"mt-5 mb-5\">\n                    <img src=\"assets/images/loading.svg\" alt=\"\">\n                </div>\n                <div *ngIf=\"!loading\" class=\"row\">\n                    <div class=\"col-lg-4\">\n                        <div class=\"sticky-top\">\n                            <div class=\"row\">\n                                <div class=\"col-lg-12 col-md-6\">\n                                    <div class=\"m-b30\">\n                                        <img src=\"{{url}}ongs/{{current_ngo.image}}/image\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\">\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12 col-md-6\">\n                                    <div class=\"widget bg-white p-lr20 p-t20  widget_getintuch radius-sm\">\n                                        <h4 class=\"text-black font-weight-700 p-t10 m-b15\">Detalles</h4>\n                                        <ul>\n                                            <li><i class=\"ti-location-pin\"></i><strong class=\"font-weight-700 text-black\">Dirección </strong><span class=\"text-black-light\"> {{current_ngo.address}} </span></li>\n                                            <li><i class=\"ti-mobile\"></i><strong class=\"font-weight-700 text-black\">Teléfono </strong>{{current_ngo.telephone}}</li>\n                                            <li><i class=\"ti-email\"></i><strong class=\"font-weight-700 text-black\">E-mail </strong>{{current_ngo.email}}</li>\n                                        </ul>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-lg-8\">\n                        <div class=\"job-info-box\">\n                            <h3 class=\"m-t0 m-b10 font-weight-700 title-head\">\n                                <span class=\"text-secondry m-r30\">{{current_ngo.name}}</span>\n                            </h3>\n                            <h5 class=\"font-weight-600\">Descripción</h5>\n                            <div class=\"dez-divider divider-2px bg-gray-dark mb-4 mt-0\"></div>\n                            <p class=\"p-t20\">{{current_ngo.description}}</p>\n                        </div>\n\n                    </div>\n                </div>\n\n            </div>\n\n        </div>\n\n    </div>\n\n</div>\n\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-settings/ngo-settings.component.html":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-settings/ngo-settings.component.html ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\"\n        style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Ajustes de ONG</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>Ajustes de ONG</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- panel area -->\n    <div class=\"py-4\">\n\n        <div class=\"row justify-content-center\">\n            <div class=\"col-md-8\">\n                \n                <div class =\"card mb-2\">\n                    <div class=\"card-header\"><a [routerLink]=\"['/volunteering/new']\">Crear Anuncio</a></div>\n                </div>\n                \n                <div class =\"card mb-2\">\n                    <div class=\"card-header\"><a [routerLink]=\"['/ngo/myvolunteerings']\">Editar Anuncio</a></div>\n                </div>\n\n                <div class=\"card\">\n                    <div class=\"card-header\">Mi cuenta</div>\n\n                    <div class=\"card-body\">\n                        <!-- Settings form -->\n                            <form #formNgoSettings = \"ngForm\" (ngSubmit) = \"onSubmit()\">\n\n                            <div class=\"form-group row\">\n                                <label for=\"name\" class=\"col-md-4 col-form-label text-md-right\">Nombre ONG</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"name\" type=\"text\" class=\"form-control\" name=\"name\" #name = \"ngModel\" [(ngModel)] = \"ngo.name\"\n                                        placeholder=\"Nombre ONG\" required autocomplete=\"name\" autofocus>\n                                    <span *ngIf = \"name.touched && !name.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"responsible_name\" class=\"col-md-4 col-form-label text-md-right\">Nombre Responsable</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"responsible_name\" type=\"text\" class=\"form-control\" name=\"responsiblename\" #responsiblename = \"ngModel\" [(ngModel)] = \"ngo.responsiblename\"\n                                        placeholder=\"Nombre Responsable\" required autofocus>\n                                    <span *ngIf = \"responsiblename.touched && !responsiblename.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"responsible_surname\" class=\"col-md-4 col-form-label text-md-right\">Apellidos Responsable</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"responsible_surname\" type=\"text\" class=\"form-control\" name=\"responsiblesurname\" #responsiblesurname = \"ngModel\" [(ngModel)] = \"ngo.responsiblesurname\"\n                                        placeholder=\"Apellidos Responsable\" required autocomplete=\"responsible_surname\" autofocus>\n                                    <span *ngIf = \"responsiblesurname.touched && !responsiblesurname.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"address\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Dirección</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"address\" type=\"text\" class=\"form-control\" name=\"address\" #address = \"ngModel\" [(ngModel)] = \"ngo.address\"\n                                        placeholder=\"Dirección\" required autocomplete=\"address\" autofocus>\n                                    <span *ngIf = \"address.touched && !address.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"postal\" class=\"col-md-4 col-form-label text-md-right\">Código Postal</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"postal\" rows=\"4\" class=\"form-control\" name=\"postal\" #postal = \"ngModel\" [(ngModel)] = \"ngo.postal\"\n                                        placeholder=\"Código Postal\" required autocomplete=\"postal\" autofocus>\n                                    <span *ngIf = \"postal.touched && !postal.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"description\"\n                                    class=\"col-md-4 col-form-label text-md-right\">Descripción</label>\n\n                                <div class=\"col-md-6\">\n                                    <textarea id=\"description\" type=\"text\" class=\"form-control\" name=\"description\" #description = \"ngModel\" [(ngModel)] = \"ngo.description\"\n                                        placeholder=\"Descripción\" required autocomplete=\"description\" autofocus></textarea>\n                                    <span *ngIf = \"description.touched && !description.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"email\" class=\"col-md-4 col-form-label text-md-right\">Email</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"email\" type=\"email\" class=\"form-control\" name=\"email\" #email = \"ngModel\" [(ngModel)] = \"ngo.email\"\n                                        placeholder=\"Email\" required autocomplete=\"email\">\n                                    <span *ngIf = \"email.touched && !email.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label for=\"telephone\" class=\"col-md-4 col-form-label text-md-right\">Teléfono</label>\n\n                                <div class=\"col-md-6\">\n                                    <input id=\"email\" type=\"telephone\" class=\"form-control\" name=\"telephone\" #telephone = \"ngModel\" [(ngModel)] = \"ngo.telephone\"\n                                        placeholder=\"Teléfono\" required autocomplete=\"telephone\">\n                                    <span *ngIf = \"telephone.touched && !telephone.valid\" style = \"color:red\">Es necesario rellenar este campo</span>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label for=\"imagenFile\" class=\"col-md-4 col-form-label text-md-right\">Foto de\n                                    perfil</label>\n\n                                <div class=\"col-md-6\">\n                                    <angular-file-uploader class=\"pointer\" [config]=\"afuConfig\" (ApiResponse)=\"avatarUpload($event)\" name=\"file0\">\n                                    </angular-file-uploader>\n                                    <!--<span *ngIf = \"image.touched && !image.valid\" style = \"color:red\">Es necesario rellenar este campo</span>-->\n                                </div>\n                            </div>\n\n                            <div class=\"form-group row mb-0\">\n                                <div class=\"col-md-6 offset-md-4\">\n                                    <input class=\"site-button\" type = \"submit\" value = \"Guardar cambios\" [disabled] = \"!formNgoSettings.valid\"/>\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n</div>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-volunteerings/ngo-volunteerings.component.html":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-volunteerings/ngo-volunteerings.component.html ***!
  \*********************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"dez-bnr-inr overlay-black-middle\"\n    style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n    <div class=\"container\">\n        <div class=\"dez-bnr-inr-entry\">\n            <h1 class=\"text-white\">Mis voluntariados</h1>\n            <!-- Breadcrumb row -->\n            <div class=\"breadcrumb-row\">\n                <ul class=\"list-inline\">\n                    <li>Inicio</li>\n                    <li>Mis voluntariados</li>\n                </ul>\n            </div>\n            <!-- Breadcrumb row END -->\n        </div>\n    </div>\n</div>\n\n\n<div *ngIf=\"!volList\" align=\"center\" class=\"mt-5 mb-5\">\n    <img src=\"assets/images/loading.svg\" alt=\"\">\n</div>\n\n<div class=\"content-block\">\n    <!-- Browse Jobs -->\n    <div class=\"section-full bg-white browse-job content-inner-2\">\n        <div class=\"container\">\n            <!--<div class=\"row\">-->\n            <div class=\"col-md-12 text-center\">\n                <h5 class=\"widget-title font-weight-700 text-uppercase\">Mis voluntariados</h5>\n                <ul class=\"post-job-bx\">\n\n\n                    <li *ngFor=\"let volunteering of volList\">\n                        <a>\n                            <div class=\"d-flex m-b30\">\n                                <div class=\"job-post-company\">\n                                    <span class=\"container-volunteering\"><img src=\"{{url}}volunteerings/image/{{volunteering.image}}\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\"/></span>    \n                                </div>\n                                <div class=\"job-post-info\">\n                                    <a class=\"custom-anchor\" [routerLink]=\"['/volunteering', volunteering.id]\"><h4>{{volunteering.name}}</h4></a>\n                                    <ul class=\"text-left\">\n                                        <li><i class=\"fa fa-map-marker\"></i>{{volunteering.city}}</li>\n                                    </ul>\n                                </div>\n                            </div>\n                            <div class=\"d-flex\">\n                                <div class=\"job-time mr-auto\">\n                                    <span>{{volunteering.category.name}}</span>\n                                </div>\n                                <div class=\"pagination-bx d-inline-block\">\n                                    <button class=\"btn btn-primary\" [routerLink]=\"['/volunteering/edit', volunteering.id]\">Editar</button>\n                                    <button (click)=\"deleteVol(volunteering.id)\"\n                                        class=\"btn btn-danger ml-2\">Retirar</button>\n                                </div>\n                            </div>\n                        </a>\n                    </li>\n\n                </ul>\n\n            </div>\n\n            <!--</div>-->\n        </div>\n    </div>\n    <!-- Browse Jobs END -->\n</div>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngos/ngos.component.html":
/*!*******************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngos/ngos.component.html ***!
  \*******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">ONGs</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>ONGs</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Find Job -->\n        <div class=\"section-full bg-white content-inner\">\n            <div class=\"container\">\n                <ul class=\"post-job-bx\">\n                    <li *ngFor=\"let ngo of data\">\n                        <a [routerLink]=\"['/ngo',ngo.id]\">\n                            <div class=\"d-flex m-b30\">\n                                <div class=\"job-post-company\">\n                                    <span><img src=\"{{url}}ongs/{{ngo.image}}/image\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\"></span>\n                                </div>\n                                <div class=\"job-post-info\">\n                                    <h4>{{ngo.name}}</h4>\n                                    <ul>\n                                        <li><i class=\"fa fa-map-marker\"></i> {{ngo.address}}</li>\n                                        <li><i class=\"fa fa-envelope\"></i> {{ngo.email}} </li>\n                                    </ul>\n                                </div>\n                            </div>\n                        </a>\n                    </li>\n                </ul>\n                <br>\n                <div *ngIf=\"loading\" align=\"center\" class=\"mt-5 mb-5\">\n                    <img src=\"assets/images/loading.svg\" alt=\"\">\n                </div>\n                <div *ngIf=\"more && !loading\" class=\"d-flex\">\n                    <div class=\"text-center\">\n                        <button class=\"site-button m-r5 button-lg\" (click)=\"moreNgos()\">Cargar más</button> \n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- Find Job END -->\n    </div>\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/register-ngo/register-ngo.component.html":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/register-ngo/register-ngo.component.html ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle bg-pt\" style=\"background-image:url(assets/images/banner/bnr2.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Registro</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a href=\"index\">Home</a></li>\n                        <li>Registro</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"section-full content-inner shop-account\">\n        <!-- Product -->\n        <div class=\"container\">\n            <div class=\"row\">\n                <div class=\"col-md-12 text-center\">\n                    <h3 class=\"font-weight-700 m-t0 m-b20\">Crear Una Cuenta</h3>\n                </div>\n            </div>\n\n            <div class=\"row\">\n                <div class=\"col-md-12 m-b30\">\n                    <div class=\"p-a30 border-1  max-w500 m-auto\">\n                        <div class=\"tab-content nav\">\n                            <form id=\"loginONGs\" class=\"tab-pane active col-12 p-a0\" #registerForm=\"ngForm\" (ngSubmit)=\"onSubmit(registerForm)\" enctype=\"multipart/form-data\">\n                                <h4 class=\"font-weight-700\">INFORMACIÓN DE LA ONG</h4>\n                                <p class=\"font-weight-600\">Si tiene una cuenta con nosotros, por favor inicie sesión.</p>\n                                <div class=\"alert alert-success mt-3\" *ngIf=\"status == 'success'\">¡Te has registrado correctamente!</div>\n                                <div class=\"alert alert-danger mt-3\" *ngIf=\"status == 'error'\">¡Ha habido un error al registrárte!</div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Nombre de la ONG *</label>\n                                    <input name=\"name\" required=\"\" class=\"form-control\" placeholder=\"Nombre\" type=\"text\" #name=\"ngModel\" [(ngModel)]=\"ngo.name\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Nombre Del Responsable *</label>\n                                    <input name=\"responsiblename\" required=\"\" class=\"form-control\" placeholder=\"Nombre\" type=\"text\" #responsiblename=\"ngModel\" [(ngModel)]=\"ngo.responsiblename\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Apellidos Del Responsable *</label>\n                                    <input name=\"responsiblesurname\" required=\"\" class=\"form-control\" placeholder=\"Apellidos\" type=\"text\" #responsiblesurname=\"ngModel\" [(ngModel)]=\"ngo.responsiblesurname\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Dirección De La Sede *</label>\n                                    <input name=\"address\" required=\"\" class=\"form-control\" placeholder=\"Dirección\" type=\"text\" #address=\"ngModel\" [(ngModel)]=\"ngo.address\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Código Postal *</label>\n                                    <input name=\"postal\" required=\"\" class=\"form-control\" placeholder=\"Código Postal\" type=\"text\" #postal=\"ngModel\" [(ngModel)]=\"ngo.postal\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">E-mail *</label>\n                                    <input name=\"email\" required=\"\" class=\"form-control\" placeholder=\"Tu Email\" type=\"email\" #email=\"ngModel\" [(ngModel)]=\"ngo.email\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Teléfono De Contacto *</label>\n                                    <input name=\"telephone\" required=\"\" class=\"form-control\" placeholder=\"Teléfono\" type=\"text\" #telephone=\"ngModel\" [(ngModel)]=\"ngo.telephone\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Contraseña *</label>\n                                    <input name=\"password\" required=\"\" class=\"form-control \" placeholder=\"Contraseña\" type=\"password\" #password=\"ngModel\" [(ngModel)]=\"ngo.password\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Descripción *</label>\n                                    <textarea name=\"description\" required=\"\" class=\"form-control \" placeholder=\"Descripción de la ong\" type=\"text\" #description=\"ngModel\" [(ngModel)]=\"ngo.description\"></textarea>\n                                </div>\n                                \n                                <div class=\"text-left\">\n                                    <input type='submit' class=\"site-button button-lg outline outline-2\" value='Enviar' [disabled]=\"registerForm.invalid\"/>\n                                    \n                                </div>\n                            </form>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- Product END -->\n    </div>\n    <!-- contact area  END -->\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/register-user/register-user.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/register-user/register-user.component.html ***!
  \*************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle bg-pt\" style=\"background-image:url(assets/images/banner/bnr2.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Registro</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a href=\"index\">Home</a></li>\n                        <li>Registro</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"section-full content-inner shop-account\">\n        <!-- Product -->\n        <div class=\"container\">\n            <div class=\"row\">\n                <div class=\"col-md-12 text-center\">\n                    <h3 class=\"font-weight-700 m-t0 m-b20\">Crear Una Cuenta</h3>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-md-12 m-b30\">\n                    <div class=\"p-a30 border-1  max-w500 m-auto\">\n                        <div class=\"tab-content nav\">\t\t\t\t\t\t\t\n                            <!--Form for Volunteers-->\n                            <form id=\"loginVolunteers\" class=\"tab-pane active\" #registerForm=\"ngForm\" (ngSubmit)=\"onSubmit(registerForm)\">\n                                <h4 class=\"font-weight-700\">INFORMACIÓN PERSONAL</h4>\n                                <p class=\"font-weight-600\">Si tiene una cuenta con nosotros, por favor inicie sesión.</p>\n                                <div class=\"alert alert-success mt-3\" *ngIf=\"status == 'success'\">¡Te has registrado correctamente!</div>\n                                <div class=\"alert alert-danger mt-3\" *ngIf=\"status == 'error'\">¡Ha habido un error al registrárte!</div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Nombre *</label>\n                                    <input name=\"name\" required=\"\" class=\"form-control\" placeholder=\"Nombre\" type=\"text\" #name=\"ngModel\" [(ngModel)]=\"user.name\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Apellidos *</label>\n                                    <input name=\"surname\" required=\"\" class=\"form-control\" placeholder=\"Apellidos\" type=\"text\" #surname=\"ngModel\" [(ngModel)]=\"user.surname\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Ciudad *</label>\n                                    <input name=\"city\" required=\"\" class=\"form-control\" placeholder=\"Ciudad\" type=\"text\" #city=\"ngModel\" [(ngModel)]=\"user.city\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">Teléfono *</label>\n                                    <input name=\"telephone\" required=\"\" class=\"form-control\" placeholder=\"Teléfono\" type=\"text\" #telephone=\"ngModel\" [(ngModel)]=\"user.telephone\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">E-MAIL *</label>\n                                    <input name=\"email\" required=\"\" class=\"form-control\" placeholder=\"Tu Email\" type=\"email\" #email=\"ngModel\" [(ngModel)]=\"user.email\">\n                                </div>\n                                <div class=\"form-group\">\n                                    <label class=\"font-weight-700\">CONTRASEÑA *</label>\n                                    <input name=\"password\" required=\"\" class=\"form-control \" placeholder=\"Contraseña\" type=\"password\" #password=\"ngModel\" [(ngModel)]=\"user.password\">\n                                </div>\n                                <div class=\"text-left\">\n                                    <button class=\"site-button button-lg outline outline-2\" [disabled]=\"registerForm.invalid\">CREAR</button>\n                                </div>\n                            </form>\n                            <!--Form for Volunteers-->\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <!--Form for ONGs-->\n\n        </div>\n        <!-- Product END -->\n    </div>\n    <!-- contact area  END -->\n</div>\n<!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle bg-pt\" style=\"background-image:url(assets/images/banner/bnr2.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Registro</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a href=\"index\">Home</a></li>\n                        <li>Registro</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"section-full content-inner shop-account\">\n        <!-- Product -->\n        <div class=\"container\">\n            <div class=\"row\">\n                <div class=\"col-md-12 text-center\">\n                    <h3 class=\"font-weight-700 m-t0 m-b20\">Crear Una Cuenta</h3>\n                </div>\n            </div>\n\n            <!--Buttons for choose if we log like ONGs or Volunteers-->\n\n            <div class=\"row\">\n                <div class=\"col-6 text-right\">\t\t\t\t\n                    <button class=\"site-button button-lg outline outline-2 m-t0 m-b20\"><a [routerLink]=\"['/register/user']\">Voluntarios</a></button>\n                    \n                </div>\n                <div class=\"col-6 text-left\">\n                    <button class=\"site-button button-lg outline outline-2 m-t0 m-b20\"><a [routerLink]=\"['/register/ong']\">ONGs</a></button>\n                </div>\n            </div>\n\n        </div>\n        <!-- Product END -->\n    </div>\n    <!-- contact area  END -->\n</div>\n<!-- Content END-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Resultados de búsqueda</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li>Inicio</li>\n                        <li>Resultados de búsqueda</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Browse Jobs -->\n        <div class=\"section-full bg-white browse-job content-inner-2\">\n            <div class=\"container\">\n                <div *ngIf=\"loading\" align=\"center\" class=\"mt-5 mb-5\">\n                    <img src=\"assets/images/loading.svg\" alt=\"\">\n                </div>\n                <div *ngIf=\"!loading\" class=\"row\">\n                    <div class=\"col-xl-9 col-lg-8\">\n                        <ul class=\"post-job-bx\">\n                            <div *ngIf=\"non_volunteerings || (non_volunteerings && keywordIndex)\">\n                                <h4 style=\"text-align: center\">¡Lo sentimos! No hay resultados</h4>\n                            </div>\n                            <div *ngIf=\"!non_volunteerings\">\n                                <div *ngIf=\"!selected_volunteerings\">\n                                    <div *ngIf=\"all_volunteerings\">\n                                        <h1 style=\"text-align: center\">TODOS LOS VOLUNTARIADOS</h1>\n                                        <li *ngFor=\"let current_volunteering of volunteerings\">\n                                            <a [routerLink]=\"['/volunteering',current_volunteering.id]\">\n                                                <div class=\"d-flex m-b30\">\n                                                    <div class=\"job-post-company\">\n                                                        <span class=\"container-volunteering\"><img src=\"{{url}}volunteerings/image/{{current_volunteering.image}}\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\"/></span>\n                                                    </div>\n                                                    <div class=\"job-post-info\">\n                                                        <h4>{{current_volunteering.name}}</h4>\n                                                        <ul>\n                                                            <li><i class=\"fa fa-map-marker\"></i>{{current_volunteering.city}} </li>\n                                                        </ul>\n                                                    </div>\n                                                </div>\n                                                <div class=\"d-flex\">\n                                                    <div class=\"job-time mr-auto\">\n                                                        <span>{{current_volunteering.category.name}}</span>\n                                                    </div>\n                                                    <div class=\"pagination-bx\">\n                                                        <span>{{current_volunteering.ong.name}}</span>\n                                                    </div>\n                                                </div>\n\n                                            </a>\n                                        </li>\n                                        <div *ngIf=\"numberPages != currentPage\">\n                                            <br>\n                                            <button class=\"site-button btn-block\" (click)=\"addFiveMoreVolunteerings()\">Cargar más</button>\n                                        </div>\n                                    </div>\n                                </div>\n\n                                <div *ngIf=\"!all_volunteerings\">\n                                    <div *ngIf=\"selected_volunteerings\">\n                                        <li *ngFor=\"let current_volunteering of selected_volunteerings\">\n                                            <a [routerLink]=\"['/volunteering',current_volunteering.id]\">\n                                                <div class=\"d-flex m-b30\">\n                                                    <div class=\"job-post-company\">\n                                                        <span class=\"container-volunteering\"><img src=\"{{url}}volunteerings/image/{{current_volunteering.image}}\" onerror=\"this.onerror=null;this.src='assets/images/user-placeholder.png'\" class=\"avatar\"/></span>\n                                                    </div>\n                                                    <div class=\"job-post-info\">\n                                                        <h4>{{current_volunteering.name}}</h4>\n                                                        <ul>\n                                                            <li><i class=\"fa fa-map-marker\"></i>{{current_volunteering.city}} </li>\n                                                        </ul>\n                                                    </div>\n                                                </div>\n                                                <div class=\"d-flex\">\n                                                    <div class=\"job-time mr-auto\">\n                                                        <span>{{current_volunteering.category}}</span>\n                                                    </div>\n                                                    <div class=\"pagination-bx\">\n                                                        <span>{{current_volunteering.ong}}</span>\n                                                    </div>\n                                                </div>\n\n                                            </a>\n                                        </li>\n                                    </div>\n                                </div>\n                            </div>\n\n                        </ul>\n\n                    </div>\n                    <div class=\"col-xl-3 col-lg-4\">\n                        <div class=\"sticky-top\">\n\n                            <div class=\"clearfix m-b30\">\n                                <form action=\"/search\" method=\"GET\">\n                                    <h5 class=\"widget-title font-weight-700 text-uppercase\">Palabras clave</h5>\n                                    <input type=\"text\" [(ngModel)]=\"word\" name=\"searchKeyword\" #searchKeyword class=\"form-control\" placeholder=\"Buscar\">\n                                    <p *ngIf=\"all_volunteerings\">\n                                        <button class=\"site-button btn-block mt-3\" (click)=\"AllVolunteeringsByWord()\" [disabled]=\"!word\">Buscar</button>\n                                    </p>\n                                    <p *ngIf=\"non_volunteerings && keywordIndex\">\n                                        <button class=\"site-button btn-block mt-3\" (click)=\"AllVolunteeringsByWord()\">Buscar</button>\n                                    </p>\n\n                                </form>\n                            </div>\n\n                            <div *ngIf=\"categories && !keywordIndex\" class=\"clearfix\">\n                                <form action=\"/search\" method=\"GET\">\n                                    <h5 class=\"widget-title font-weight-700 text-uppercase\">Categorias</h5>\n                                    <select name=\"cate\" #cate [(ngModel)]=\"categor\" class=\"form-control\">\n                                            <option [ngValue]=\"category.id\" *ngFor=\"let category of categories\">{{category.id}}. {{category.name}}</option>\n                                    </select>\n                                    <br>\n                                    <p *ngIf=\"all_volunteerings\">\n                                        <button class=\"site-button btn-block\" (click)=\"AllVolunteeringsByCategory()\">Buscar</button>\n                                    </p>\n\n                                </form>\n                            </div>\n                            <br>\n                            <div *ngIf=\"selected_volunteerings\">\n                                <div *ngIf=\"!keywordIndex\"><button class=\"site-button btn-block mt-3\" (click)=\"ngOnInit();searchKeyword.value='';cate.value=''\">Limpiar Búsqueda</button></div>\n                                <div *ngIf=\"keywordIndex\"><a class=\"site-button btn-block mt-3\" [routerLink]=\"['/search']\">Limpiar Búsqueda</a></div>\n                            </div>\n\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n\n        <!-- Browse Jobs END -->\n    </div>\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/user-settings/user-settings.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/user-settings/user-settings.component.html ***!
  \*************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\"\n        style=\"background-image:url(assets/images/background/Volunteerswalk.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 class=\"text-white\">Ajustes de usuario</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>Ajustes de usuario</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- panel area -->\n    <div class=\"py-4\">\n\n        <div class=\"row justify-content-center\">\n            <div class=\"col-md-8\">\n                <div class=\"card\">\n                    <div class=\"card-header\">Mi cuenta</div>\n                    <div class=\"card-body\">\n                        <!-- Settings form -->\n                        <form #settingsForm=\"ngForm\" (ngSubmit)=\"onSubmit(settingsForm)\" enctype=\"multipart/form-data\">\n                            <div class=\"form-group row\">\n                                <label for=\"name\" class=\"col-md-4 col-form-label text-md-right\">Nombre</label>\n                                <div class=\"col-md-6\">\n                                    <input id=\"name\" type=\"text\" class=\"form-control\" name=\"name\"\n                                        placeholder=\"Nombre\" required autocomplete=\"name\" autofocus value=\"{{user.name}}\" #name=\"ngModel\" [(ngModel)]=\"user.name\">\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label for=\"surname\" class=\"col-md-4 col-form-label text-md-right\">Apellidos</label>\n                                <div class=\"col-md-6\">\n                                    <input id=\"surname\" type=\"text\" class=\"form-control\" name=\"surname\"\n                                        placeholder=\"Apellidos\" required autocomplete=\"surname\" value=\"{{user.surname}}\" #surname=\"ngModel\" [(ngModel)]=\"user.surname\">\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label for=\"surname\" class=\"col-md-4 col-form-label text-md-right\">Ciudad</label>\n                                <div class=\"col-md-6\">\n                                    <input id=\"city\" type=\"text\" class=\"form-control\" name=\"city\"\n                                        placeholder=\"Ciudad\" required autocomplete=\"city\" autofocus value=\"{{user.city}}\" #city=\"ngModel\" [(ngModel)]=\"user.city\">\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label for=\"surname\" class=\"col-md-4 col-form-label text-md-right\">Teléfono</label>\n                                <div class=\"col-md-6\">\n                                    <input id=\"telephone\" type=\"text\" class=\"form-control\" name=\"telephone\"\n                                        placeholder=\"Teléfono\" required autocomplete=\"Teléfono\" autofocus value=\"{{user.telephone}}\" #telephone=\"ngModel\" [(ngModel)]=\"user.telephone\">\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label for=\"email\" class=\"col-md-4 col-form-label text-md-right\">Email</label>\n                                <div class=\"col-md-6\">\n                                    <input id=\"email\" type=\"email\" class=\"form-control\" name=\"email\"\n                                        placeholder=\"Email\" required autocomplete=\"email\" value=\"{{user.email}}\" #email=\"ngModel\" [(ngModel)]=\"user.email\">\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label for=\"imagenFile\" class=\"col-md-4 col-form-label text-md-right\">Foto de\n                                    perfil</label>\n\n                                <div class=\"col-md-6\">\n                                    <angular-file-uploader class=\"pointer\" [config]=\"afuConfig\" (ApiResponse)=\"avatarUpload($event)\" name=\"file0\">\n                                    </angular-file-uploader>\n                                </div>\n                            </div>\n                            <div class=\"form-group row mb-0\">\n                                <div class=\"col-md-6 offset-md-4\">\n                                    <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"settingsForm.invalid\">\n                                        Guardar cambios\n                                    </button>\n                                </div>\n                            </div>\n                    </form>\n                    <br>\n\n                            <div class=\"form-group row mb-0\">\n                                <div class=\"col-md-6 offset-md-4\">\n                                    \n                                    <!-- Button trigger modal -->\n                                        <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#exampleModal\">\n                                          Eliminar Cuenta\n                                        </button>\n                                        \n                                        <!-- Modal -->\n                                        <div class=\"modal fade\" id=\"exampleModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n                                          <div class=\"modal-dialog\" role=\"document\">\n                                            <div class=\"modal-content\">\n                                              <div class=\"modal-header\">\n                                                <h5 class=\"modal-title\" id=\"exampleModalLabel\">Borrar Cuenta</h5>\n                                                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                                                  <span aria-hidden=\"true\">&times;</span>\n                                                </button>\n                                              </div>\n                                              <div class=\"modal-body\">\n                                                ¿Realmente quiere eliminar la cuenta?\n                                              </div>\n                                              <div class=\"modal-footer\">\n                                                <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancelar</button>\n                                                <button type=\"submit\" class=\"btn btn-primary\" data-dismiss=\"modal\" (click)=\"deleteUser()\">Eliminar</button>\n                                              </div>\n                                            </div>\n                                          </div>\n                                        </div>\n                                </div>\n                            </div>\n                            \n                        \n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n</div>\n<!-- Content END-->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/volunteering-page/volunteering-page.component.html":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/volunteering-page/volunteering-page.component.html ***!
  \*********************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Content -->\n<div class=\"page-content bg-white\">\n    <!-- inner page banner -->\n    <div class=\"dez-bnr-inr overlay-black-middle\" style=\"background-image:url(assets/images/background/fondo.jpg);\">\n        <div class=\"container\">\n            <div class=\"dez-bnr-inr-entry\">\n                <h1 *ngIf=\"volunteering\" class=\"text-white\">{{volunteering.name}}</h1>\n                <!-- Breadcrumb row -->\n                <div class=\"breadcrumb-row\">\n                    <ul class=\"list-inline\">\n                        <li><a [routerLink]=\"['/']\">Inicio</a></li>\n                        <li>Voluntariado</li>\n                    </ul>\n                </div>\n                <!-- Breadcrumb row END -->\n            </div>\n        </div>\n    </div>\n    <!-- inner page banner END -->\n    <!-- contact area -->\n    <div class=\"content-block\">\n        <!-- Helping Congo -->\n        <div class=\"section-full content-inner-1\">\n            <div class=\"container\">\n                <div class=\"row\" *ngIf=\"!volunteering\"><img src=\"assets/images/loading.svg\" alt=\"\"\n                        class=\"rounded mx-auto d-block\"></div>\n                <div class=\"row\" *ngIf=\"volunteering\">\n                    <div class=\"col-lg-4\">\n                        <div class=\"sticky-top\">\n                            <div class=\"row\">\n                                <div class=\"col-lg-12 col-md-6\">\n                                    <div class=\"m-b30\">\n\n                                        <img src=\"{{this.url}}volunteerings/image/{{volunteering.image}}\" alt=\"\"\n                                            *ngIf=\"volunteering.image != 'false'\">\n                                        <img src=\"assets/images/placeholder-2.png\" alt=\"\"\n                                            *ngIf=\"volunteering.image == 'false'\">\n\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12 col-md-6\">\n                                    <div class=\"widget bg-white p-lr20 p-t20  widget_getintuch radius-sm\">\n                                        <h4 class=\"text-black font-weight-700 p-t10 m-b15\">Detalles</h4>\n                                        <ul>\n                                            <li><i class=\"ti-location-pin\"></i><strong\n                                                    class=\"font-weight-700 text-black\">Ciudad</strong><span\n                                                    class=\"text-black-light\"> {{volunteering.city}} </span></li>\n                                            <li><i class=\"ti-email\"></i><strong\n                                                    class=\"font-weight-700 text-black\">E-mail</strong>{{volunteering.email}}\n                                            </li>\n                                            <li><i class=\"ti-bookmark\"></i><strong\n                                                    class=\"font-weight-700 text-black\">Categoría</strong>{{volunteering.category.name}}\n                                            </li>\n                                            <li><i class=\"ti-timer\"></i><strong class=\"font-weight-700 text-black\">Fecha\n                                                    de inicio</strong>{{volunteering.startdate}}</li>\n                                        </ul>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-lg-8\">\n                        <div class=\"job-info-box\">\n                            <h3 class=\"m-t0 m-b10 font-weight-700 title-head\">\n                                <span class=\"text-secondry m-r30\">{{volunteering.name}}</span>\n                            </h3>\n                            <ul class=\"job-info\">\n                                <li><i class=\"ti-bookmark text-black m-r5\"></i><strong>Categoría</strong>\n                                    {{volunteering.category.name}}</li>\n                                <li><i class=\"ti-timer text-black m-r5\"></i><strong>Fecha límite</strong>\n                                    {{volunteering.enddate}}</li>\n                                <li><i class=\"ti-location-pin text-black m-r5\"></i> {{volunteering.city}} </li>\n                                <li><i class=\"fa fa-heart text-black m-r5\"></i> {{likesNumber}} <span>Me gusta</span>\n                                </li>\n\n                            </ul>\n                            <p class=\"p-t20\"></p>\n\n                            <h5 class=\"font-weight-600\">Descripción</h5>\n                            <div class=\"dez-divider divider-2px bg-gray-dark mb-4 mt-0\"></div>\n                            <p class=\"p-t20\">{{volunteering.description}}</p>\n\n                            <div *ngIf=\"entity_type == 'user' && !identity.roles.includes('ROLE_ADMIN')\">\n                                <button *ngIf=\"!isJoined\" type=\"submit\" class=\"btn btn-primary\"\n                                    (click)=\"join(volunteering.id)\">Apuntarse</button>\n                                <button *ngIf=\"isJoined\" type=\"submit\" class=\"btn btn-danger\"\n                                    (click)=\"join(volunteering.id)\">Desapuntarse</button>\n                                <span class=\"ml-2\" *ngIf=\"alert\" style=\"color: green\">¡Te has apuntado al\n                                    voluntariado!</span>\n                            </div>\n                            <div>\n                                <br>\n                                <iframe width=\"600\" height=\"450\" frameborder=\"0\" style=\"border:0\"\n                                    [src]=\"sanitizeURL()\"\n                                    allowfullscreen></iframe>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- Job Detail -->\n    </div>\n    <br>\n</div>\n<div *ngIf=\"entity_type == 'user' && !identity.roles.includes('ROLE_ADMIN')\">\n\n    <div class=\"like-button {{btnColor}}\" (click)=\"like(volunteering.id)\">\n        <i class=\"fa fa-heart like {{iconColor}}\"></i>\n    </div>\n</div>\n\n    <!-- Content END-->\n");
...
/* harmony import */ var _components_ngos_ngos_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/ngos/ngos.component */ "./src/app/components/ngos/ngos.component.ts");
...
/* harmony import */ var _components_ngo_details_ngo_details_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/ngo-details/ngo-details.component */ "./src/app/components/ngo-details/ngo-details.component.ts");
...
/* harmony import */ var _components_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/register-user/register-user.component */ "./src/app/components/register-user/register-user.component.ts");
/* harmony import */ var _components_register_ngo_register_ngo_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/register-ngo/register-ngo.component */ "./src/app/components/register-ngo/register-ngo.component.ts");
/* harmony import */ var _components_user_settings_user_settings_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/user-settings/user-settings.component */ "./src/app/components/user-settings/user-settings.component.ts");
/* harmony import */ var _components_joined_volunteerings_joined_volunteerings_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/joined-volunteerings/joined-volunteerings.component */ "./src/app/components/joined-volunteerings/joined-volunteerings.component.ts");
...
/* harmony import */ var _components_volunteering_page_volunteering_page_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/volunteering-page/volunteering-page.component */ "./src/app/components/volunteering-page/volunteering-page.component.ts");
/* harmony import */ var _components_edit_volunteering_edit_volunteering_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/edit-volunteering/edit-volunteering.component */ "./src/app/components/edit-volunteering/edit-volunteering.component.ts");
/* harmony import */ var _components_ngo_settings_ngo_settings_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/ngo-settings/ngo-settings.component */ "./src/app/components/ngo-settings/ngo-settings.component.ts");
/* harmony import */ var _components_create_volunteering_create_volunteering_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/create-volunteering/create-volunteering.component */ "./src/app/components/create-volunteering/create-volunteering.component.ts");
/* harmony import */ var _components_admin_ngos_admin_ngos_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/admin-ngos/admin-ngos.component */ "./src/app/components/admin-ngos/admin-ngos.component.ts");
/* harmony import */ var _components_admin_users_admin_users_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/admin-users/admin-users.component */ "./src/app/components/admin-users/admin-users.component.ts");
/* harmony import */ var _components_admin_volunteerings_admin_volunteerings_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/admin-volunteerings/admin-volunteerings.component */ "./src/app/components/admin-volunteerings/admin-volunteerings.component.ts");
...
/* harmony import */ var _components_admin_comments_admin_comments_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/admin-comments/admin-comments.component */ "./src/app/components/admin-comments/admin-comments.component.ts");
/* harmony import */ var _components_ngo_volunteerings_ngo_volunteerings_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/ngo-volunteerings/ngo-volunteerings.component */ "./src/app/components/ngo-volunteerings/ngo-volunteerings.component.ts");
/* harmony import */ var _components_error_error_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/error/error.component */ "./src/app/components/error/error.component.ts");
/* harmony import */ var _services_user_guard__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./services/user.guard */ "./src/app/services/user.guard.ts");
/* harmony import */ var _services_ngo_guard__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./services/ngo.guard */ "./src/app/services/ngo.guard.ts");
/* harmony import */ var _services_anonymous_guard__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./services/anonymous.guard */ "./src/app/services/anonymous.guard.ts");
/* harmony import */ var _services_admin_guard__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./services/admin.guard */ "./src/app/services/admin.guard.ts");
...
const routes = [
    { path: '', component: _components_index_index_component__WEBPACK_IMPORTED_MODULE_4__["IndexComponent"] },
    { path: 'ngos', component: _components_ngos_ngos_component__WEBPACK_IMPORTED_MODULE_3__["NgosComponent"] },
    { path: "login", canActivate: [_services_anonymous_guard__WEBPACK_IMPORTED_MODULE_27__["AnonymousGuard"]], component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"] },
    { path: "register", canActivate: [_services_anonymous_guard__WEBPACK_IMPORTED_MODULE_27__["AnonymousGuard"]], component: _components_register_register_component__WEBPACK_IMPORTED_MODULE_8__["RegisterComponent"] },
    { path: "register/user", canActivate: [_services_anonymous_guard__WEBPACK_IMPORTED_MODULE_27__["AnonymousGuard"]], component: _components_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_9__["RegisterUserComponent"] },
    { path: "register/ong", canActivate: [_services_anonymous_guard__WEBPACK_IMPORTED_MODULE_27__["AnonymousGuard"]], component: _components_register_ngo_register_ngo_component__WEBPACK_IMPORTED_MODULE_10__["RegisterNgoComponent"] },
    { path: "user/settings", canActivate: [_services_user_guard__WEBPACK_IMPORTED_MODULE_25__["UserGuard"]], component: _components_user_settings_user_settings_component__WEBPACK_IMPORTED_MODULE_11__["UserSettingsComponent"] },
    { path: "user/myvolunteerings", canActivate: [_services_user_guard__WEBPACK_IMPORTED_MODULE_25__["UserGuard"]], component: _components_joined_volunteerings_joined_volunteerings_component__WEBPACK_IMPORTED_MODULE_12__["JoinedVolunteeringsComponent"] },
    { path: "contact", component: _components_contact_contact_component__WEBPACK_IMPORTED_MODULE_13__["ContactComponent"] },
    { path: "volunteering/new", canActivate: [_services_ngo_guard__WEBPACK_IMPORTED_MODULE_26__["NGOGuard"]], component: _components_create_volunteering_create_volunteering_component__WEBPACK_IMPORTED_MODULE_17__["CreateVolunteeringComponent"] },
    { path: "volunteering/:id", component: _components_volunteering_page_volunteering_page_component__WEBPACK_IMPORTED_MODULE_14__["VolunteeringPageComponent"] },
    { path: "volunteering/edit/:id", canActivate: [_services_ngo_guard__WEBPACK_IMPORTED_MODULE_26__["NGOGuard"]], component: _components_edit_volunteering_edit_volunteering_component__WEBPACK_IMPORTED_MODULE_15__["EditVolunteeringComponent"] },
    { path: "ngo/settings", canActivate: [_services_ngo_guard__WEBPACK_IMPORTED_MODULE_26__["NGOGuard"]], component: _components_ngo_settings_ngo_settings_component__WEBPACK_IMPORTED_MODULE_16__["NgoSettingsComponent"] },
    { path: "admin/ngos", canActivate: [_services_admin_guard__WEBPACK_IMPORTED_MODULE_28__["AdminGuard"]], component: _components_admin_ngos_admin_ngos_component__WEBPACK_IMPORTED_MODULE_18__["AdminNgosComponent"] },
    { path: "admin/users", canActivate: [_services_admin_guard__WEBPACK_IMPORTED_MODULE_28__["AdminGuard"]], component: _components_admin_users_admin_users_component__WEBPACK_IMPORTED_MODULE_19__["AdminUsersComponent"] },
    { path: "admin/volunteerings", canActivate: [_services_admin_guard__WEBPACK_IMPORTED_MODULE_28__["AdminGuard"]], component: _components_admin_volunteerings_admin_volunteerings_component__WEBPACK_IMPORTED_MODULE_20__["AdminVolunteeringsComponent"] },
    { path: 'admin/comments', canActivate: [_services_admin_guard__WEBPACK_IMPORTED_MODULE_28__["AdminGuard"]], component: _components_admin_comments_admin_comments_component__WEBPACK_IMPORTED_MODULE_22__["AdminCommentsComponent"] },
    { path: "ngo/myvolunteerings", canActivate: [_services_ngo_guard__WEBPACK_IMPORTED_MODULE_26__["NGOGuard"]], component: _components_ngo_volunteerings_ngo_volunteerings_component__WEBPACK_IMPORTED_MODULE_23__["NgoVolunteeringsComponent"] },
    { path: 'ngo/:id', component: _components_ngo_details_ngo_details_component__WEBPACK_IMPORTED_MODULE_5__["NgoDetailsComponent"] },
    { path: 'search', component: _components_search_search_component__WEBPACK_IMPORTED_MODULE_6__["SearchComponent"] },
    { path: 'search/:wordIndex', component: _components_search_search_component__WEBPACK_IMPORTED_MODULE_6__["SearchComponent"] },
    { path: 'about-us', component: _components_about_us_about_us_component__WEBPACK_IMPORTED_MODULE_21__["AboutUsComponent"] },
    { path: '**', component: _components_error_error_component__WEBPACK_IMPORTED_MODULE_24__["ErrorComponent"] }
];
...
/* harmony import */ var _components_ngos_ngos_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/ngos/ngos.component */ "./src/app/components/ngos/ngos.component.ts");
...
/* harmony import */ var _components_ngo_details_ngo_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/ngo-details/ngo-details.component */ "./src/app/components/ngo-details/ngo-details.component.ts");
...
/* harmony import */ var _components_ngo_settings_ngo_settings_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/ngo-settings/ngo-settings.component */ "./src/app/components/ngo-settings/ngo-settings.component.ts");
/* harmony import */ var _components_create_volunteering_create_volunteering_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/create-volunteering/create-volunteering.component */ "./src/app/components/create-volunteering/create-volunteering.component.ts");
/* harmony import */ var _components_edit_volunteering_edit_volunteering_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/edit-volunteering/edit-volunteering.component */ "./src/app/components/edit-volunteering/edit-volunteering.component.ts");
...
/* harmony import */ var _services_entity_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/entity.service */ "./src/app/services/entity.service.ts");
...
/* harmony import */ var _components_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/register-user/register-user.component */ "./src/app/components/register-user/register-user.component.ts");
/* harmony import */ var _components_register_ngo_register_ngo_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/register-ngo/register-ngo.component */ "./src/app/components/register-ngo/register-ngo.component.ts");
/* harmony import */ var _components_user_settings_user_settings_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/user-settings/user-settings.component */ "./src/app/components/user-settings/user-settings.component.ts");
/* harmony import */ var _components_joined_volunteerings_joined_volunteerings_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/joined-volunteerings/joined-volunteerings.component */ "./src/app/components/joined-volunteerings/joined-volunteerings.component.ts");
...
/* harmony import */ var _components_volunteering_page_volunteering_page_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/volunteering-page/volunteering-page.component */ "./src/app/components/volunteering-page/volunteering-page.component.ts");
/* harmony import */ var _components_admin_ngos_admin_ngos_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./components/admin-ngos/admin-ngos.component */ "./src/app/components/admin-ngos/admin-ngos.component.ts");
/* harmony import */ var _components_admin_users_admin_users_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/admin-users/admin-users.component */ "./src/app/components/admin-users/admin-users.component.ts");
/* harmony import */ var _components_admin_volunteerings_admin_volunteerings_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/admin-volunteerings/admin-volunteerings.component */ "./src/app/components/admin-volunteerings/admin-volunteerings.component.ts");
/* harmony import */ var _components_about_us_about_us_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/about-us/about-us.component */ "./src/app/components/about-us/about-us.component.ts");
/* harmony import */ var _components_ngo_volunteerings_ngo_volunteerings_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/ngo-volunteerings/ngo-volunteerings.component */ "./src/app/components/ngo-volunteerings/ngo-volunteerings.component.ts");
/* harmony import */ var _components_admin_comments_admin_comments_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/admin-comments/admin-comments.component */ "./src/app/components/admin-comments/admin-comments.component.ts");
/* harmony import */ var _components_error_error_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/error/error.component */ "./src/app/components/error/error.component.ts");
/* harmony import */ var _services_user_guard__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./services/user.guard */ "./src/app/services/user.guard.ts");
/* harmony import */ var _services_ngo_guard__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./services/ngo.guard */ "./src/app/services/ngo.guard.ts");
/* harmony import */ var _services_anonymous_guard__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./services/anonymous.guard */ "./src/app/services/anonymous.guard.ts");
/* harmony import */ var _services_admin_guard__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./services/admin.guard */ "./src/app/services/admin.guard.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_ngos_ngos_component__WEBPACK_IMPORTED_MODULE_9__["NgosComponent"],
            _components_index_index_component__WEBPACK_IMPORTED_MODULE_10__["IndexComponent"],
            _components_ngo_details_ngo_details_component__WEBPACK_IMPORTED_MODULE_11__["NgoDetailsComponent"],
            _components_search_search_component__WEBPACK_IMPORTED_MODULE_12__["SearchComponent"],
            _components_ngo_settings_ngo_settings_component__WEBPACK_IMPORTED_MODULE_13__["NgoSettingsComponent"],
            _components_create_volunteering_create_volunteering_component__WEBPACK_IMPORTED_MODULE_14__["CreateVolunteeringComponent"],
            _components_edit_volunteering_edit_volunteering_component__WEBPACK_IMPORTED_MODULE_15__["EditVolunteeringComponent"],
            ...
            _components_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_20__["RegisterUserComponent"],
            _components_register_ngo_register_ngo_component__WEBPACK_IMPORTED_MODULE_21__["RegisterNgoComponent"],
            _components_user_settings_user_settings_component__WEBPACK_IMPORTED_MODULE_22__["UserSettingsComponent"],
            _components_joined_volunteerings_joined_volunteerings_component__WEBPACK_IMPORTED_MODULE_23__["JoinedVolunteeringsComponent"],
            _components_contact_contact_component__WEBPACK_IMPORTED_MODULE_24__["ContactComponent"],
            _components_volunteering_page_volunteering_page_component__WEBPACK_IMPORTED_MODULE_25__["VolunteeringPageComponent"],
            _components_admin_ngos_admin_ngos_component__WEBPACK_IMPORTED_MODULE_26__["AdminNgosComponent"],
            _components_admin_users_admin_users_component__WEBPACK_IMPORTED_MODULE_27__["AdminUsersComponent"],
            _components_admin_volunteerings_admin_volunteerings_component__WEBPACK_IMPORTED_MODULE_28__["AdminVolunteeringsComponent"],
            _components_about_us_about_us_component__WEBPACK_IMPORTED_MODULE_29__["AboutUsComponent"],
            _components_ngo_volunteerings_ngo_volunteerings_component__WEBPACK_IMPORTED_MODULE_30__["NgoVolunteeringsComponent"],
            _components_admin_comments_admin_comments_component__WEBPACK_IMPORTED_MODULE_31__["AdminCommentsComponent"],
            _components_error_error_component__WEBPACK_IMPORTED_MODULE_32__["ErrorComponent"]
        ],
        imports: [
        ...
        providers: [_services_entity_service__WEBPACK_IMPORTED_MODULE_18__["EntityService"], _services_user_guard__WEBPACK_IMPORTED_MODULE_33__["UserGuard"], _services_ngo_guard__WEBPACK_IMPORTED_MODULE_34__["NGOGuard"], _services_anonymous_guard__WEBPACK_IMPORTED_MODULE_35__["AnonymousGuard"], _services_admin_guard__WEBPACK_IMPORTED_MODULE_36__["AdminGuard"]],
...
/***/ "./src/app/components/admin-comments/admin-comments.component.css":
/*!************************************************************************!*\
  !*** ./src/app/components/admin-comments/admin-comments.component.css ***!
  \************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvYWRtaW4tY29tbWVudHMvYWRtaW4tY29tbWVudHMuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/components/admin-comments/admin-comments.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/components/admin-comments/admin-comments.component.ts ***!
  \***********************************************************************/
...
let AdminCommentsComponent = class AdminCommentsComponent {
    constructor(_commentService, _titleService) {
    ...
    getComments() {
        this._commentService.get().subscribe((response) => {
            if (response) {
    ...
    deleteComment(commentId) {
        this._commentService.delete(commentId).subscribe((response) => {
            if (response) {
                this.status = "success";
                this.getComments();
            }
...
AdminCommentsComponent.ctorParameters = () => [
...
AdminCommentsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-comments.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-comments/admin-comments.component.html")).default,
        providers: [_services_comment_service__WEBPACK_IMPORTED_MODULE_2__["CommentService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-comments.component.css */ "./src/app/components/admin-comments/admin-comments.component.css")).default]
    })
...
/***/ "./src/app/components/admin-ngos/admin-ngos.component.css":
/*!****************************************************************!*\
  !*** ./src/app/components/admin-ngos/admin-ngos.component.css ***!
  \****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvYWRtaW4tbmdvcy9hZG1pbi1uZ29zLmNvbXBvbmVudC5jc3MifQ== */");

/***/ }),

/***/ "./src/app/components/admin-ngos/admin-ngos.component.ts":
/*!***************************************************************!*\
  !*** ./src/app/components/admin-ngos/admin-ngos.component.ts ***!
  \***************************************************************/
/*! exports provided: AdminNgosComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminNgosComponent", function() { return AdminNgosComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_ngo_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/ngo.service */ "./src/app/services/ngo.service.ts");
...
let AdminNgosComponent = class AdminNgosComponent {
    constructor(_ngoService, _titleService) {
        this._ngoService = _ngoService;
        this._titleService = _titleService;
        this.loading = true;
        this.more = false;
        this.data = [];
    ...
    ngOnInit() {
        this._ngoService.getNgos(0).subscribe(result => {
            this.data = result;
            this.more = true;
            this.loading = false;
        }, error => {
        ...
        this._ngoService.getNgos(1).subscribe(result => {
    ...
    deleteNgo(id, $event) {
        ...
        $event.target.value = "Procesando";
        this._ngoService.delete(id).subscribe((response) => {
            if (response) {
                $event.target.value = "Eliminada";
            }
        }, error => {
    ...
    moreNgos() {
        ...
        this._ngoService.getNgos(this.page).subscribe(result => {
            this.additional = result;
            this.more = true;
            this.page++;
            this.loading = false;
...
AdminNgosComponent.ctorParameters = () => [
    { type: _services_ngo_service__WEBPACK_IMPORTED_MODULE_2__["NgoService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["Title"] }
];
AdminNgosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-admin-ngos',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-ngos.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-ngos/admin-ngos.component.html")).default,
        providers: [_services_ngo_service__WEBPACK_IMPORTED_MODULE_2__["NgoService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-ngos.component.css */ "./src/app/components/admin-ngos/admin-ngos.component.css")).default]
    })
], AdminNgosComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvYWRtaW4tdXNlcnMvYWRtaW4tdXNlcnMuY29tcG9uZW50LmNzcyJ9 */");
...
let AdminUsersComponent = class AdminUsersComponent {
    constructor(_userService, _titleService) {
    ...
    moreUsers() {
        ...
        this.data = this.data.concat(this.additional);
        if (this.more) {
            this._userService.getUsers(this.page).subscribe(result => {
                this.additional = result;
                this.more = true;
                this.page++;
                this.loading = false;
    ...
    getUsers() {
        this._userService.getUsers(0).subscribe(result => {
            this.data = result;
            this.loading = false;
        }, error => {
            console.log("No hay nada");
        });
        this._userService.getUsers(1).subscribe(result => {
            this.additional = result;
            this.more = true;
        }, error => {
            this.more = false;
...
AdminUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-users.component.css */ "./src/app/components/admin-users/admin-users.component.css")).default]
    })
], AdminUsersComponent);
...
/***/ "./src/app/components/admin-volunteerings/admin-volunteerings.component.css":
/*!**********************************************************************************!*\
  !*** ./src/app/components/admin-volunteerings/admin-volunteerings.component.css ***!
  \**********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvYWRtaW4tdm9sdW50ZWVyaW5ncy9hZG1pbi12b2x1bnRlZXJpbmdzLmNvbXBvbmVudC5jc3MifQ== */");

/***/ }),

/***/ "./src/app/components/admin-volunteerings/admin-volunteerings.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/components/admin-volunteerings/admin-volunteerings.component.ts ***!
  \*********************************************************************************/
/*! exports provided: AdminVolunteeringsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminVolunteeringsComponent", function() { return AdminVolunteeringsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_volunteering_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/volunteering.service */ "./src/app/services/volunteering.service.ts");
/* harmony import */ var _services_global__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/global */ "./src/app/services/global.ts");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
let AdminVolunteeringsComponent = class AdminVolunteeringsComponent {
    constructor(_volunteeringService, _titleService) {
        this._volunteeringService = _volunteeringService;
        this._titleService = _titleService;
        this.loading = true;
        this.more = false;
        this.data = [];
    ...
    ngOnInit() {
        this._volunteeringService.getVolunteeringsByPage(0).subscribe(result => {
            this.data = result;
            this.loading = false;
        }, error => {
            console.log("No hay nada");
        });
        this._volunteeringService.getVolunteeringsByPage(1).subscribe(result => {
            this.additional = result;
            this.more = true;
        }, error => {
            this.more = false;
    ...
    deleteVolunteering(id, $event) {
        $event.target.disabled = true;
        $event.target.value = "Procesando";
        this._volunteeringService.deleteoneVolunteering(id).subscribe((response) => {
            if (response) {
                $event.target.value = "Eliminado";
            }
        }, error => {
    ...
    moreVolunteerings() {
        ...
        this.data = this.data.concat(this.additional);
        if (this.more) {
            this._volunteeringService.getVolunteeringsByPage(this.page).subscribe(result => {
                this.additional = result;
                this.more = true;
                this.page++;
                this.loading = false;
...
AdminVolunteeringsComponent.ctorParameters = () => [
    { type: _services_volunteering_service__WEBPACK_IMPORTED_MODULE_2__["VolunteeringService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["Title"] }
];
AdminVolunteeringsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-admin-volunteerings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-volunteerings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin-volunteerings/admin-volunteerings.component.html")).default,
        providers: [_services_volunteering_service__WEBPACK_IMPORTED_MODULE_2__["VolunteeringService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-volunteerings.component.css */ "./src/app/components/admin-volunteerings/admin-volunteerings.component.css")).default]
    })
...
let ContactComponent = class ContactComponent {
    constructor(_commentService, _titleService) {
        ...
        this.comment = new _models_comment__WEBPACK_IMPORTED_MODULE_3__["Comment"](null, "", "", "");
    }
    ngOnInit() {
    }
    onSubmit(form) {
        this._commentService.create(this.comment).subscribe(response => {
            if (response.id != null) {
                this.status = "success";
                form.reset();
            }
...
/***/ "./src/app/components/create-volunteering/create-volunteering.component.css":
/*!**********************************************************************************!*\
  !*** ./src/app/components/create-volunteering/create-volunteering.component.css ***!
  \**********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvY3JlYXRlLXZvbHVudGVlcmluZy9jcmVhdGUtdm9sdW50ZWVyaW5nLmNvbXBvbmVudC5jc3MifQ== */");

/***/ }),

/***/ "./src/app/components/create-volunteering/create-volunteering.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/components/create-volunteering/create-volunteering.component.ts ***!
  \*********************************************************************************/
/*! exports provided: CreateVolunteeringComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateVolunteeringComponent", function() { return CreateVolunteeringComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_models_volunteering__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/models/volunteering */ "./src/app/models/volunteering.ts");
/* harmony import */ var src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/volunteering.service */ "./src/app/services/volunteering.service.ts");
...
/* harmony import */ var src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/ngo.service */ "./src/app/services/ngo.service.ts");
...
let CreateVolunteeringComponent = class CreateVolunteeringComponent {
    constructor(_volunteeringService, _ngoService, _categoryService, _entityService, _titleService) {
        this._volunteeringService = _volunteeringService;
        this._ngoService = _ngoService;
        ...
        this.volunteering = new src_app_models_volunteering__WEBPACK_IMPORTED_MODULE_2__["Volunteering"](null, null, null, "", null, null, null, "", "", "", null, "");
        this.getCategories();
    ...
    onSubmit(form) {
        ...
        this._volunteeringService.create(this.volunteering).subscribe((response) => {
            if (response) {
    ...
    onImageSubmit() {
        this._volunteeringService.updateVolunteering(this.volunteering.id, this.volunteering).subscribe((response) => {
            if (response) {
                this.volunteering = response;
                this.status = "success";
            }
    ...
    ngOnDestroy() {
        this._ngoService.getNgo(this.ngoLogged.id).subscribe((response) => {
            if (response) {
...
CreateVolunteeringComponent.ctorParameters = () => [
    { type: src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"] },
    { type: src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_7__["NgoService"] },
...
CreateVolunteeringComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-create-volunteering',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./create-volunteering.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/create-volunteering/create-volunteering.component.html")).default,
        providers: [src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"], src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_7__["NgoService"], src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_6__["EntityService"], src_app_services_category_service__WEBPACK_IMPORTED_MODULE_4__["CategoryService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./create-volunteering.component.css */ "./src/app/components/create-volunteering/create-volunteering.component.css")).default]
    })
...
/***/ "./src/app/components/edit-volunteering/edit-volunteering.component.css":
/*!******************************************************************************!*\
  !*** ./src/app/components/edit-volunteering/edit-volunteering.component.css ***!
  \******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvZWRpdC12b2x1bnRlZXJpbmcvZWRpdC12b2x1bnRlZXJpbmcuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/components/edit-volunteering/edit-volunteering.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/components/edit-volunteering/edit-volunteering.component.ts ***!
  \*****************************************************************************/
/*! exports provided: EditVolunteeringComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditVolunteeringComponent", function() { return EditVolunteeringComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_models_volunteering__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/models/volunteering */ "./src/app/models/volunteering.ts");
/* harmony import */ var src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/volunteering.service */ "./src/app/services/volunteering.service.ts");
...
let EditVolunteeringComponent = class EditVolunteeringComponent {
    constructor(_volunteeringService, _ngoService, _categoryService, _route, _router, _titleService) {
        this._volunteeringService = _volunteeringService;
        this._ngoService = _ngoService;
        this._categoryService = _categoryService;
        this._route = _route;
    ...
    getVolunteering(volId) {
        this._volunteeringService.getVolunteeringById(volId).subscribe((response) => {
...
EditVolunteeringComponent.ctorParameters = () => [
    { type: src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"] },
    { type: src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_7__["NgoService"] },
    { type: src_app_services_category_service__WEBPACK_IMPORTED_MODULE_4__["CategoryService"] },
...
EditVolunteeringComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-volunteering',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-volunteering.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/edit-volunteering/edit-volunteering.component.html")).default,
        providers: [src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"], src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_7__["NgoService"], src_app_services_category_service__WEBPACK_IMPORTED_MODULE_4__["CategoryService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-volunteering.component.css */ "./src/app/components/edit-volunteering/edit-volunteering.component.css")).default]
    })
...
/***/ "./src/app/components/index/canvasjs.min.js":
/*!**************************************************!*\
  !*** ./src/app/components/index/canvasjs.min.js ***!
  \**************************************************/
/*! no static exports found */
...
/* harmony import */ var _canvasjs_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./canvasjs.min */ "./src/app/components/index/canvasjs.min.js");
...
let IndexComponent = class IndexComponent {
    constructor(_categoryService, _userService, router, _titleService) {
        this._categoryService = _categoryService;
        this._userService = _userService;
        this.router = router;
        this._titleService = _titleService;
    ...
    ngOnInit() {
        this._userService.getStats().subscribe(result => {
            for (let i = 0; i < 12; i++) {
            ...
            let chart = new _canvasjs_min__WEBPACK_IMPORTED_MODULE_5__["Chart"]("chartContainer", {
...
IndexComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_services_category_service__WEBPACK_IMPORTED_MODULE_3__["CategoryService"], _services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]],
...
/***/ "./src/app/components/joined-volunteerings/joined-volunteerings.component.css":
/*!************************************************************************************!*\
  !*** ./src/app/components/joined-volunteerings/joined-volunteerings.component.css ***!
  \************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvam9pbmVkLXZvbHVudGVlcmluZ3Mvam9pbmVkLXZvbHVudGVlcmluZ3MuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/components/joined-volunteerings/joined-volunteerings.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/components/joined-volunteerings/joined-volunteerings.component.ts ***!
  \***********************************************************************************/
/*! exports provided: JoinedVolunteeringsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JoinedVolunteeringsComponent", function() { return JoinedVolunteeringsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let JoinedVolunteeringsComponent = class JoinedVolunteeringsComponent {
    constructor(_entityService, _volunteeringService, _titleService) {
        this._entityService = _entityService;
        this._volunteeringService = _volunteeringService;
        this._titleService = _titleService;
    ...
    ngOnInit() {
        this._volunteeringService.getByJoined(this.identity.id).subscribe(response => {
...
JoinedVolunteeringsComponent.ctorParameters = () => [
    { type: _services_entity_service__WEBPACK_IMPORTED_MODULE_2__["EntityService"] },
    { type: src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["Title"] }
];
JoinedVolunteeringsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-joined-volunteerings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./joined-volunteerings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/joined-volunteerings/joined-volunteerings.component.html")).default,
        providers: [_services_entity_service__WEBPACK_IMPORTED_MODULE_2__["EntityService"], src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./joined-volunteerings.component.css */ "./src/app/components/joined-volunteerings/joined-volunteerings.component.css")).default]
    })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_models_logeable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/models/logeable */ "./src/app/models/logeable.ts");
...
let LoginComponent = class LoginComponent {
    constructor(_route, _router, _entityService, _titleService) {
        this._route = _route;
        this._router = _router;
        this._entityService = _entityService;
        this._titleService = _titleService;
        ...
        this.logeable = new src_app_models_logeable__WEBPACK_IMPORTED_MODULE_3__["Logeable"]("", "", "user");
    }
    ngOnInit() {
    }
    onSubmit(form) {
        this._entityService.login(this.logeable).subscribe(response => {
            if (response.id) {
...
LoginComponent.ctorParameters = () => [
    ...
    { type: _services_entity_service__WEBPACK_IMPORTED_MODULE_4__["EntityService"] },
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_services_entity_service__WEBPACK_IMPORTED_MODULE_4__["EntityService"]],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".pointer{\ncursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let NavbarComponent = class NavbarComponent {
    constructor(_entityService, _router, _route) {
        this._entityService = _entityService;
        this._router = _router;
        this._route = _route;
    ...
    logout() {
        this._entityService.logout().subscribe(response => {
            if (response == true) {
                this.identity = null;
...
/***/ "./src/app/components/ngo-details/ngo-details.component.css":
/*!******************************************************************!*\
  !*** ./src/app/components/ngo-details/ngo-details.component.css ***!
  \******************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvbmdvLWRldGFpbHMvbmdvLWRldGFpbHMuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/components/ngo-details/ngo-details.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/components/ngo-details/ngo-details.component.ts ***!
  \*****************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_ngo_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/ngo.service */ "./src/app/services/ngo.service.ts");
/* harmony import */ var _services_global__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/global */ "./src/app/services/global.ts");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
let NgoDetailsComponent = class NgoDetailsComponent {
    constructor(_route, _router, _ngoService, _titleService) {
        this._route = _route;
        this._router = _router;
        this._ngoService = _ngoService;
        this._titleService = _titleService;
    ...
    ngOnInit() {
        ...
        this._ngoService.getNgo(this.id_ngo).subscribe(response => {
            if (response.id != null) {
...
NgoDetailsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services_ngo_service__WEBPACK_IMPORTED_MODULE_3__["NgoService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__["Title"] }
];
NgoDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-ngo-details',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ngo-details.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-details/ngo-details.component.html")).default,
        providers: [_services_ngo_service__WEBPACK_IMPORTED_MODULE_3__["NgoService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ngo-details.component.css */ "./src/app/components/ngo-details/ngo-details.component.css")).default]
    })
], NgoDetailsComponent);
...
/***/ "./src/app/components/ngo-settings/ngo-settings.component.css":
/*!********************************************************************!*\
  !*** ./src/app/components/ngo-settings/ngo-settings.component.css ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvbmdvLXNldHRpbmdzL25nby1zZXR0aW5ncy5jb21wb25lbnQuY3NzIn0= */");

/***/ }),

/***/ "./src/app/components/ngo-settings/ngo-settings.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/components/ngo-settings/ngo-settings.component.ts ***!
  \*******************************************************************/
/*! exports provided: NgoSettingsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgoSettingsComponent", function() { return NgoSettingsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_models_ngo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/models/ngo */ "./src/app/models/ngo.ts");
...
/* harmony import */ var _services_global__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/global */ "./src/app/services/global.ts");
/* harmony import */ var src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/entity.service */ "./src/app/services/entity.service.ts");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
let NgoSettingsComponent = class NgoSettingsComponent {
    constructor(_ngoService, _entityService, _titleService) {
        this._ngoService = _ngoService;
        this._entityService = _entityService;
        this._titleService = _titleService;
        this._titleService.setTitle("Mis ajustes - VoluntaWeb");
        this.ngo = new src_app_models_ngo__WEBPACK_IMPORTED_MODULE_2__["NGO"](null, "", "", "", "", "", "", "", "", null, "", "");
        this.url = _services_global__WEBPACK_IMPORTED_MODULE_4__["global"].url;
        this.token = localStorage.getItem('authorization');
        this.identity = this._entityService.getIdentity();
        this.afuConfig = {
    ...
    onSubmit(formNgo) {
        this._ngoService.updateNgo(this.ngo).subscribe((response) => {
            if (response.id) {
                this.ngo = response;
...
NgoSettingsComponent.ctorParameters = () => [
    { type: src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_3__["NgoService"] },
    { type: src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_5__["EntityService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__["Title"] }
];
NgoSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-ngo-settings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ngo-settings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-settings/ngo-settings.component.html")).default,
        providers: [src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_3__["NgoService"], src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_5__["EntityService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ngo-settings.component.css */ "./src/app/components/ngo-settings/ngo-settings.component.css")).default]
    })
...
/***/ "./src/app/components/ngo-volunteerings/ngo-volunteerings.component.css":
/*!******************************************************************************!*\
  !*** ./src/app/components/ngo-volunteerings/ngo-volunteerings.component.css ***!
  \******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvbmdvLXZvbHVudGVlcmluZ3MvbmdvLXZvbHVudGVlcmluZ3MuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/components/ngo-volunteerings/ngo-volunteerings.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/components/ngo-volunteerings/ngo-volunteerings.component.ts ***!
  \*****************************************************************************/
/*! exports provided: NgoVolunteeringsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgoVolunteeringsComponent", function() { return NgoVolunteeringsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/ngo.service */ "./src/app/services/ngo.service.ts");
/* harmony import */ var src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/volunteering.service */ "./src/app/services/volunteering.service.ts");
/* harmony import */ var src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/entity.service */ "./src/app/services/entity.service.ts");
...
let NgoVolunteeringsComponent = class NgoVolunteeringsComponent {
    constructor(_route, _router, _ngoService, _volunteeringService, _entityService, _titleService) {
        this._route = _route;
        this._router = _router;
        this._ngoService = _ngoService;
        this._volunteeringService = _volunteeringService;
    ...
    getNGO() {
        this._ngoService.getNgo(this.NGO.id).subscribe(result => {
            this.NGO = result;
            this.volList = this.NGO.volunteerings;
        }, error => { console.log(error); });
    }
    deleteVol(volid) {
        this._volunteeringService.deleteoneVolunteering(volid).subscribe(response => {
            this.getNGO();
        }, error => {
            console.log(error);
        });
...
NgoVolunteeringsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_3__["NgoService"] },
    { type: src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_4__["VolunteeringService"] },
    { type: src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_5__["EntityService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_7__["Title"] }
];
NgoVolunteeringsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'ngo-volunteerings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ngo-volunteerings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngo-volunteerings/ngo-volunteerings.component.html")).default,
        providers: [src_app_services_ngo_service__WEBPACK_IMPORTED_MODULE_3__["NgoService"], src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_4__["VolunteeringService"], src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_5__["EntityService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ngo-volunteerings.component.css */ "./src/app/components/ngo-volunteerings/ngo-volunteerings.component.css")).default]
    })
...
/***/ "./src/app/components/ngos/ngos.component.css":
/*!****************************************************!*\
  !*** ./src/app/components/ngos/ngos.component.css ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvbmdvcy9uZ29zLmNvbXBvbmVudC5jc3MifQ== */");

/***/ }),

/***/ "./src/app/components/ngos/ngos.component.ts":
/*!***************************************************!*\
  !*** ./src/app/components/ngos/ngos.component.ts ***!
  \***************************************************/
/*! exports provided: NgosComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgosComponent", function() { return NgosComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_ngo_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/ngo.service */ "./src/app/services/ngo.service.ts");
/* harmony import */ var _services_global__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/global */ "./src/app/services/global.ts");
...
let NgosComponent = class NgosComponent {
    constructor(_ngoService, _titleService) {
        this._ngoService = _ngoService;
        this._titleService = _titleService;
        this.loading = true;
...
NgosComponent.ctorParameters = () => [
    { type: _services_ngo_service__WEBPACK_IMPORTED_MODULE_2__["NgoService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["Title"] }
];
NgosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-ngos',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ngos.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/ngos/ngos.component.html")).default,
        providers: [_services_ngo_service__WEBPACK_IMPORTED_MODULE_2__["NgoService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ngos.component.css */ "./src/app/components/ngos/ngos.component.css")).default]
    })
], NgosComponent);
...
/***/ "./src/app/components/register-ngo/register-ngo.component.css":
/*!********************************************************************!*\
  !*** ./src/app/components/register-ngo/register-ngo.component.css ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvcmVnaXN0ZXItbmdvL3JlZ2lzdGVyLW5nby5jb21wb25lbnQuY3NzIn0= */");

/***/ }),

/***/ "./src/app/components/register-ngo/register-ngo.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/components/register-ngo/register-ngo.component.ts ***!
  \*******************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_ngo_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/ngo.service */ "./src/app/services/ngo.service.ts");
/* harmony import */ var src_app_models_ngo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/models/ngo */ "./src/app/models/ngo.ts");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
let RegisterNgoComponent = class RegisterNgoComponent {
    constructor(_ngoService, _titleService) {
        this._ngoService = _ngoService;
        this._titleService = _titleService;
        this._titleService.setTitle("Registrarse como ONG - VoluntaWeb");
        this.ngo = new src_app_models_ngo__WEBPACK_IMPORTED_MODULE_3__["NGO"](null, "", "", "", "", "", "", "", "", null, null, "");
    }
    ngOnInit() {
    }
    onSubmit(form) {
...
RegisterNgoComponent.ctorParameters = () => [
    { type: _services_ngo_service__WEBPACK_IMPORTED_MODULE_2__["NgoService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["Title"] }
];
RegisterNgoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-register-ngo',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./register-ngo.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/register-ngo/register-ngo.component.html")).default,
        providers: [_services_ngo_service__WEBPACK_IMPORTED_MODULE_2__["NgoService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./register-ngo.component.css */ "./src/app/components/register-ngo/register-ngo.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvcmVnaXN0ZXItdXNlci9yZWdpc3Rlci11c2VyLmNvbXBvbmVudC5jc3MifQ== */");
...
let RegisterUserComponent = class RegisterUserComponent {
    constructor(_userService, _titleService) {
        ...
        this.user = new src_app_models_user__WEBPACK_IMPORTED_MODULE_2__["User"](null, null, null, "", "", "", "", "", "", null, "", null);
    }
    ngOnInit() {
    }
    onSubmit(form) {
...
RegisterUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./register-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/register-user/register-user.component.html")).default,
        providers: [_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./register-user.component.css */ "./src/app/components/register-user/register-user.component.css")).default]
    })
...
/* harmony import */ var _services_volunteering_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/volunteering.service */ "./src/app/services/volunteering.service.ts");
...
let SearchComponent = class SearchComponent {
    constructor(_route, _router, _searchService, _volunteeringService, _categoryService, _titleService) {
        this._route = _route;
        this._router = _router;
    ...
    AllVolunteerings() {
        this._searchService.getSearch(0).subscribe(response => {
            this.selected_volunteerings = null;
    ...
    getNumberPages() {
        this._volunteeringService.getVolunteerings().subscribe(response => {
    ...
    addFiveMoreVolunteerings() {
        ...
        this._searchService.getSearch(this.currentPage).subscribe(response => {
    ...
    AllVolunteeringsByWord() {
        this._searchService.getByWord(this.word).subscribe(response => {
    ...
    AllVolunteeringsByCategory() {
        this._searchService.getByCategory(this.categor).subscribe(response => {
            this.selected_volunteerings = response;
            this.all_volunteerings = null;
            this.non_volunteerings = false;
            this.loading = false;
...
SearchComponent.ctorParameters = () => [
    ...
    { type: _services_volunteering_service__WEBPACK_IMPORTED_MODULE_4__["VolunteeringService"] },
...
SearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [_services_search_service__WEBPACK_IMPORTED_MODULE_3__["SearchService"], _services_category_service__WEBPACK_IMPORTED_MODULE_5__["CategoryService"], _services_volunteering_service__WEBPACK_IMPORTED_MODULE_4__["VolunteeringService"]],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvdXNlci1zZXR0aW5ncy91c2VyLXNldHRpbmdzLmNvbXBvbmVudC5jc3MifQ== */");
...
let UserSettingsComponent = class UserSettingsComponent {
    constructor(_userService, _entityService, _router, _route, _titleService) {
        this._userService = _userService;
        this._entityService = _entityService;
        this._router = _router;
        this._route = _route;
    ...
    deleteUser() {
        ...
        this._userService.delete(userId).subscribe(response => {
            if (response.id) {
                this.status = "success";
                localStorage.removeItem("authorization");
                localStorage.removeItem("identity");
...
UserSettingsComponent.ctorParameters = () => [
    ...
    { type: src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_3__["EntityService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
...
UserSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-settings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/user-settings/user-settings.component.html")).default,
        providers: [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_3__["EntityService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-settings.component.css */ "./src/app/components/user-settings/user-settings.component.css")).default]
    })
...
/***/ "./src/app/components/volunteering-page/volunteering-page.component.css":
/*!******************************************************************************!*\
  !*** ./src/app/components/volunteering-page/volunteering-page.component.css ***!
  \******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvdm9sdW50ZWVyaW5nLXBhZ2Uvdm9sdW50ZWVyaW5nLXBhZ2UuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/components/volunteering-page/volunteering-page.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/components/volunteering-page/volunteering-page.component.ts ***!
  \*****************************************************************************/
...
let VolunteeringPageComponent = class VolunteeringPageComponent {
    constructor(_route, _router, _volunteeringService, _entityService, _titleService, _sanitizer) {
        this._route = _route;
        this._router = _router;
        this._volunteeringService = _volunteeringService;
        this._entityService = _entityService;
    ...
    isJoinedF(volId) {
        this._volunteeringService.isJoined(this.volunteering.id).subscribe((response) => {
    ...
    isLikedF(volId) {
        this._volunteeringService.isLiked(this.volunteering.id).subscribe((response) => {
    ...
    join(volId) {
        this._volunteeringService.join(volId).subscribe(response => {
            this.isJoined = response;
            if (this.isJoined) {
                this.alert = true;
            }
    ...
    like(volId) {
        this._volunteeringService.like(volId).subscribe(response => {
            this.isLiked = response;
            if (this.isLiked) {
...
VolunteeringPageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"] },
...
VolunteeringPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-volunteering-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./volunteering-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/volunteering-page/volunteering-page.component.html")).default,
        providers: [src_app_services_volunteering_service__WEBPACK_IMPORTED_MODULE_3__["VolunteeringService"], src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_4__["EntityService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./volunteering-page.component.css */ "./src/app/components/volunteering-page/volunteering-page.component.css")).default]
    })
...
class Comment {
    constructor(id, email, message, name) {
        this.id = id;
        this.email = email;
...
/***/ "./src/app/models/logeable.ts":
/*!************************************!*\
  !*** ./src/app/models/logeable.ts ***!
  \************************************/
/*! exports provided: Logeable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Logeable", function() { return Logeable; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/***/ "./src/app/models/ngo.ts":
/*!*******************************!*\
  !*** ./src/app/models/ngo.ts ***!
  \*******************************/
/*! exports provided: NGO */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class NGO {
    constructor(id, name, responsiblename, responsiblesurname, description, address, email, postal, image, volunteerings, telephone, password) {
        this.id = id;
        this.name = name;
...
class User {
    constructor(id, registrations, likes, name, surname, email, password, city, telephone, roles, image, registeredAt) {
        this.id = id;
...
/***/ "./src/app/models/volunteering.ts":
/*!****************************************!*\
  !*** ./src/app/models/volunteering.ts ***!
  \****************************************/
/*! exports provided: Volunteering */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Volunteering", function() { return Volunteering; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class Volunteering {
    constructor(id, joined_user, likes, name, category, startdate, enddate, description, image, city, ong, email) {
        this.id = id;
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _entity_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./entity.service */ "./src/app/services/entity.service.ts");




let AdminGuard = class AdminGuard {
    constructor(_router, _entityService) {
        this._router = _router;
        this._entityService = _entityService;
    }
    canActivate() {
...
/***/ "./src/app/services/anonymous.guard.ts":
/*!*********************************************!*\
  !*** ./src/app/services/anonymous.guard.ts ***!
  \*********************************************/
...
let CommentService = class CommentService {
    ...
    delete(commentId) {
        ...
        */
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json").set('Authorization', 'Basic ' + this.getLoggedUserToken());
...
let EntityService = class EntityService {
    ...
    login(logeable) {
        ...
        //Headers
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', "application/json").set("Authorization", "Basic " + encodedData);
        //REST request
    ...
    logout() {
        ...
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json").set("Authorization", "Basic " + token);
...
var global = {
    url: 'https://213.37.156.237:8443/api/'
};


/***/ }),

/***/ "./src/app/services/ngo.guard.ts":
/*!***************************************!*\
  !*** ./src/app/services/ngo.guard.ts ***!
  \***************************************/
/*! exports provided: NGOGuard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NGOGuard", function() { return NGOGuard; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _entity_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./entity.service */ "./src/app/services/entity.service.ts");
...
NGOGuard.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _entity_service__WEBPACK_IMPORTED_MODULE_3__["EntityService"] }
];
NGOGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], NGOGuard);
...
let NgoService = class NgoService {
    ...
    updateNgo(ngo) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json').set("Authorization", "Basic " + this.getLoggedNgoToken());
...
NgoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
NgoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], NgoService);
...
/***/ "./src/app/services/volunteering.service.ts":
/*!**************************************************!*\
  !*** ./src/app/services/volunteering.service.ts ***!
  \**************************************************/
...
let VolunteeringService = class VolunteeringService {
    constructor(_http) {
        this._http = _http;
        this.url = _global__WEBPACK_IMPORTED_MODULE_3__["global"].url;
    }
    ...
    updateVolunteering(volunteringId, volunteering) {
    ...
    getVolunteeringsByPage(page) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
        return this._http.get(this.url + 'volunteerings/?page=' + page, { headers: headers });
    }
    deleteoneVolunteering(volid) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', "application/json").set('Authorization', 'Basic ' + this.getLoggedUserToken());
        return this._http.delete(this.url + 'volunteerings/' + volid, { headers: headers });
    }
};
VolunteeringService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
VolunteeringService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], VolunteeringService);
